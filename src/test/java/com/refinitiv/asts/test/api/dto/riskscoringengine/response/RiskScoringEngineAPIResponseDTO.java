...
@Data
public class RiskScoringEngineAPIResponseDTO {
    ...
    public boolean equals( Object otherObj ) {
        ...
        if (! (otherObj instanceof RiskScoringEngineAPIResponseDTO) ) {
            return false;
        }
        RiskScoringEngineAPIResponseDTO other = (RiskScoringEngineAPIResponseDTO) otherObj;
