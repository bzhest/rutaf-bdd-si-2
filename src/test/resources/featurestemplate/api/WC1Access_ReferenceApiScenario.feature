...
#    Given Run API Tests with custom hooks features:[siconnect],tags:@putCases
    ...
    Given Run API Tests with custom hooks features:[wcaccess],tags:@getReferenceCountriesAll
    Given Run API Tests with custom hooks features:[wcaccess],tags:@getReferenceNationalitiesAll
    Given Run API Tests with custom hooks features:[wcaccess],tags:@getReferenceProvidersAll
