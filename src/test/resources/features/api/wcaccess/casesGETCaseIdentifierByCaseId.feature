@api @getCasesCaseIdentifierByCaseId @siconnect_api
Feature: Get Case Identifier by Case Id

  Background:
    * def getUrl = 'https://worldcheck.qa-sprint2.supplierintegrity.com' +'/caseIdentifiers' +'?caseId=5jb7i8k5wgod1fna25awdu0of'

  Scenario: Retrieve case identifier by case id
    Given url getUrl
