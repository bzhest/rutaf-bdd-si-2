@api @deleteDelegateReviewByCaseSystemIdAndResultId @siconnect_api
Feature: Delete Delegate Review by Case System Id and Result Id

  Background:
    * def baseUrl = 'https://worldcheck.qa-sprint2.supplierintegrity.com'

  Scenario: Delete Delegate Review by Case System Id and Result Id
    Given url deleteUrl = baseUrl +'/cases' +'/5jb726g7vpqk1fnxxt2nol23r' +'/results' +'/5jb7ekd7c44j1fnxxt4n7ad0p'  +'/review/delegate'
