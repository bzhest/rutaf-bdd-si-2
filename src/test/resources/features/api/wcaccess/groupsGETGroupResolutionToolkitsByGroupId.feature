@api @getGroupResolutionToolkitsByGroupId @siconnect_api
Feature: Get Group Resolution Toolkits by Group Id

  Background:
    * def getUrl = 'https://nightly.iwpro.api.integrawatch.com/groups' +'/5jb6818vag7o1fi12uwekwd2y' +'/resolutionToolkits'
