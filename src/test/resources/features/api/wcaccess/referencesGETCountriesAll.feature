@api @getReferenceCountriesAll @siconnect_api
Feature: Get All Reference Countries

  Background:
    * def getUrl = 'https://nightly.iwpro.api.integrawatch.com/reference/countries'
#    * def getUrl = wc1Url +'/reference/countries'
