@api @public_api @postPublicQSTAssignAdhocQuestionnaireInternalQSTToExternalUser
Feature: Post Assign Adhoc Questionnaire
  ...
  Scenario: C39241085 : Public API - POST /thirdparty/{id}/assign-questionnaire - Verify error if Internal Questionnaire is assigned to External user
