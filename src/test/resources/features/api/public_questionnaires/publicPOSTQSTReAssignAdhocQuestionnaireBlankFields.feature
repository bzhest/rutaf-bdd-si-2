@api @public_api @postPublicQSTReAssignAdhocQuestionnaireBlankFields
Feature: Post ReAssign Adhoc Questionnaire Blank Fields
  ...
  Scenario: C39241092 : Public API - POST /thirdparty/{id}/reassign-questionnaire-assignment-activity - Verify error for Invalid values
