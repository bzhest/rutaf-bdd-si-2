@api @public_api @postPublicQSTAssignAdhocQuestionnaireMultiQSTInternalUser
Feature: Post Assign Adhoc Questionnaire
  ...
  Background:
    ...
    * def newPostAssignQST =
        """
         ...
         "questionnaireNames": ["SAMPLE AUTO QUESTIONNAIRE", "SAMPLE AUTO QUESTIONNAIRE 2", "SAMPLE AUTO QUESTIONNAIRE 3"],
  ...
  Scenario: C39241076 : Public API - POST /thirdparty/{id}/assign-questionnaire- Assign Multiple Questionnaires to Internal User
