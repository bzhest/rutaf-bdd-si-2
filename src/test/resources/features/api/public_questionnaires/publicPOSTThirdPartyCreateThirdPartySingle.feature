@api @public_api @postPublicThirdPartyCreateThirdPartySingleQST
Feature: Create Single Third Party
  ...
  Background:
    ...
    * def companyNameWithUUID = "QST_RDDC_AUTO_TEST_" + uuid()
