@api @public_api @postPublicQSTAssignAdhocQuestionnaire
Feature: Post Assign Adhoc Questionnaire
  ...
  Scenario: C39241074 : Public API - POST /thirdparty/{id}/assign-questionnaire - Assign Single Questionnaire to Internal User
