@api @public_api @getPublicQSTRetrieveQuestionnaireAssignmentDetailsVerifyInvalidLanguage
Feature: Get Questionnaire Assignment Details
  ...
  Scenario: C39215948 : Public API - GET/thirdparty/{id}questionnaires/{assignmentId} - Verify error message for Language that does not exist
