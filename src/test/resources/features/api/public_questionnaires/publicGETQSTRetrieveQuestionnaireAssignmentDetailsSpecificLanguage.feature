@api @public_api @getPublicQSTRetrieveQuestionnaireAssignmentDetailsSpecificLanguage
Feature: Get Questionnaire Assignment Details
  ...
  Scenario: C39215945 : Public API - GET/thirdparty/{id}questionnaires/{assignmentId} - Retrieve Questionnaire Details for specific Language
