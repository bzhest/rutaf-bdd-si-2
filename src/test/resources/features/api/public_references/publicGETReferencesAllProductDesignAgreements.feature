@api @public_api @getPublicReferencesAllProductDesignAgreements
Feature: Get All Product Design Agreements
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36067556 [RMS-6944] Public API
            - Verify Get Design Agreement List (Static Value)

#
#  Get All Product Design Agreements
#

    Given url getUrl = baseTestUrl
    And path 'references/product-design-agreements'
    ...
    * def eTag = responseHeaders['ETag'][0].split('"')[1]
    And print '\n'
    And print '================================'
    And print '******** PRODUCT DESIGN AGREEMENTS'
