@api @public_api @getPublicReferencesAllSourcingTypes
Feature: Get All Sourcing Types
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36098882 Public API - GET Sourcing Type List (Static Value)
               - Verify that Sourcing Type details are displayed & Response Code is 200

#
# Get All Sourcing Types
#

    Given url getUrl = baseTestUrl
    And path 'references/sourcing-types'
  ...
  Scenario: 2) C36098883 Public API - GET Sourcing Type List (Static Value)
...
#
#  Scenario: 3) C36098884 Public API - GET Sourcing Type List (Static Value)
#               - Verify that X-Tenant-Code parameter is required
#
#  #
#  # Test when 'X-Tenant-Code' header is invalid/missig
#  #
#    Given url getUrl = baseTestUrl
#    And path 'references/sourcing-types'
