@api @public_api @getPublicReferencesAllRelationshipVisibilityTypes
Feature: Get All Relationship Visibility Types
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36098792 [RMS-6945] Public API
               - Verify Get Relationship Visibility List (Static Value)

#
# Get All Relationship Visibility Types
#


    Given url getUrl = baseTestUrl
    And path 'references/relationship-visibility-types'
    ...
    * def eTag = responseHeaders['ETag'][0].split('"')[1]
    And print '\n'
    And print '================================'
    And print '******** RELATIONSHIP VISIBILITY TYPES'
