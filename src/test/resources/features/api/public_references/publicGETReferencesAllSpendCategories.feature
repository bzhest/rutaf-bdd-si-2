@api @public_api @getPublicReferencesAllSpendCategories
Feature: Get All Spend Categories
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36098876 Public API - GET Spend Category List (Static Value)
               - Verify that Spend Category details are displayed and Response Code is 200
...
#
    ...
    And path 'references/spend-categories'
  ...
  Scenario: 2) C36098877 Public API - GET Spend Category List (Static Value)
...
#
#  Scenario: 3) C36098878 Public API - GET Spend Category List (Static Value)
