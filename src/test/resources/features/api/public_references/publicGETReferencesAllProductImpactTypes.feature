@api @public_api @getPublicReferencesAllProductImpactTypes
Feature: Get All Product Impact Types
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36067610 [RMS-6946] Public API
               - Verify Get Product Impact List (Static Value)

#
# Get All Product Impact Types
#


    Given url getUrl = baseTestUrl
    And path 'references/product-impact-types'
    ...
    * def eTag = responseHeaders['ETag'][0].split('"')[1]
    And print '\n'
    And print '================================'
    And print '******** PRODUCT IMPACT TYPES'
