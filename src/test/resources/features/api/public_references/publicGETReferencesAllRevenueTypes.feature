@api @public_api @getPublicReferencesAllRevenueTypes
Feature: Get All Revenue Types
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36098869 Public API - GET Revenue List (Static Value)
               - Verify that Revenue details are displayed & Response Code is 200
...
#
    ...
    And path 'references/revenue-types'
  ...
  Scenario: 2) C36098870 Public API - GET Revenue List (Static Value)
...
#
#  Scenario: 3) C36098871 Public API - GET Revenue List (Static Value)
