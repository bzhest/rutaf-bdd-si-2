@api @public_api @getPublicReferencesAllCurrencies
...
#    * def baseTestUrl = 'https://api.qa-sprint2.supplierintegrity.com'
  ...
  Scenario: 1) C36067609 [RMS-6947] Public API
               - Verify Get Currency List (Static Value)
...
#
    ...
    And path 'references/currencies'
