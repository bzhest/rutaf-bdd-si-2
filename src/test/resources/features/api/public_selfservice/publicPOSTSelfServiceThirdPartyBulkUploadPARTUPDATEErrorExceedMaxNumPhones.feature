@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEErrorExceedMaxNumPhones
...
#      """
  ...
  Scenario: 01) C37786725 Third-party - PARTUPDATE
                - Verify error for Maximum number of Phone Number exceeded

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) EXCEED MAX NUM PHONES ERROR - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-MAXNUMPHONES-ERR'
...
#    And print '\n'
    ...
    * def phoneNumber01 =      retrieveThirdPartyByIdResult1[0].response.data.contactInformation.phoneNumber[0]
    * def phoneNumberLength1 = retrieveThirdPartyByIdResult1[0].response.data.contactInformation.phoneNumber.length

    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( phoneNumberLength1 == 1 )        +'  COUNT         ="'+ phoneNumberLength1 +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber01  == '1234567890' ) +'  phoneNumber01 ="'+ phoneNumber01      +'"'
    And print '==================================================\n'
    And print '\n'
...
# ==================================================================================================================
# ======== Case-01) UPDATE MAX NUM PHONE NUMBERS - 5 rows: Success ==========
# ==================================================================================================================
#
...
#    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def phoneNumber02 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber[0]
    * def phoneNumber12 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber[1]
    * def phoneNumber22 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber[2]
    * def phoneNumber32 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber[3]
    * def phoneNumber42 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber[4]

    * def phoneNumberLength2 =   retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber.length
#
##    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( phoneNumberLength2 == 5 )           +'  COUNT         ="'+ phoneNumberLength2 +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber02 == '1800111111111' )  +'  phoneNumber02 ="'+ phoneNumber02      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber12 == '1800222222222' )  +'  phoneNumber12 ="'+ phoneNumber12      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber22 == '1800333333333' )  +'  phoneNumber22 ="'+ phoneNumber22      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber32 == '1800444444444' )  +'  phoneNumber32 ="'+ phoneNumber32      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber42 == '1800555555555' )  +'  phoneNumber42 ="'+ phoneNumber42      +'"'
    And print '==================================================\n'
    And print '\n'
...
# ==================================================================================================================
# ======== Case-02) EXCEED MAX NUM WEBSITES - 6 rows: Error ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |www.test01.com|   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |www.test02.com|   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |www.test03.com|   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows04 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |www.test04.com|   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows05 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |www.test05.com|   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows06 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |www.test06.com|   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
...
##    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def phoneNumber03 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.phoneNumber[0]
    * def phoneNumber13 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.phoneNumber[1]
    * def phoneNumber23 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.phoneNumber[2]
    * def phoneNumber33 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.phoneNumber[3]
    * def phoneNumber43 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.phoneNumber[4]

    * def phoneNumberLength3 =   retrieveThirdPartyByIdResult3[0].response.data.contactInformation.phoneNumber.length
#
##    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( phoneNumberLength3 == 5 )           +'  COUNT         ="'+ phoneNumberLength3 +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber03 == '1800111111111' )  +'  phoneNumber03 ="'+ phoneNumber03      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber13 == '1800222222222' )  +'  phoneNumber13 ="'+ phoneNumber13      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber23 == '1800333333333' )  +'  phoneNumber23 ="'+ phoneNumber23      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber33 == '1800444444444' )  +'  phoneNumber33 ="'+ phoneNumber33      +'"'
    And print 'VALIDATE MATCH ='+ ( phoneNumber43 == '1800555555555' )  +'  phoneNumber43 ="'+ phoneNumber43      +'"'
    And print '==================================================\n'
    And print '\n'
