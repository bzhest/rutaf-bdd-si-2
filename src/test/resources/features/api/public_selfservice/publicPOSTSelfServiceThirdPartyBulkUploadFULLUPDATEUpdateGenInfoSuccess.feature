@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEUpdateGenInfoSuccess
...
# Success: General Information
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Philippines|            |           |   |             |           |                    |          |               |                  |                  |                   |              |                         |           |                |\n"
