@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorInvalidDates
...
# Error: Invalid date - Date of Incorporation
    * def csvRows01 = "FULLUPDATE |"+ thirdPartyId +"|                |1       |FULUPD-"+nowMs+"|            |        |                 |             |                 |incDate-xxxxxxxx     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default        |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Canada |            |       |   |             |           |                    |          |               |                  |                  |                   |              |                         |           |                |\n"
...
# Error: Invalid date - Liquidation Date
    * def csvRows01 = "FULLUPDATE |"+ thirdPartyId +"|                |1       |FULUPD-"+nowMs+"|            |        |                 |             |                 |                     |       |liqDate-xxxxxxxx|           |rddcentre.admin.np@refinitiv.com|MyDivision|Default        |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Canada |            |       |   |             |           |                    |          |               |                  |                  |                   |              |                         |           |                |\n"
