@api @public_api @postPublicSelfServiceThirdPartyBulkUploadDELETEThirdParty3Error2Success
...
#      """
  ...
  Scenario: 01) C37797275  Third-party - DELETE
                - Delete third-party - 3 errors 2 success

    * def nowMs01 = call fnGetNowMs

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) DELETE THIRD-PARTIES 3 ERROR 2 SUCCESS - DELETE'
...
#
    ...
    * def nameVarTARGET =       'DEL-3P-3ERR-2SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |si_admin@yopmail.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme Inc.   |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    ...
    * def csvRows02 = "DELETE     |                         |               |2       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows03 = "DELETE     |"+    thirdPartyId02   +"|               |3       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows04 = "DELETE     |XxXxXxXxXxXxXxXxXxXxXxXxX|               |4       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows05 = "DELETE     |xXxXxXxXxXxXxXxXxXxXxXxXx|               |5       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
...
#
    ...
    * def validateSuccess2 = ( retrieveSelfServiceProcess2_response.data.recordProcessed==2 && retrieveSelfServiceProcess2_response.data.recordWithErrors==3 )
