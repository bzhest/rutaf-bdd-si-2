@api @public_api @postPublicSelfServiceContactBulkUploadADDContactErrorInvalidFileType
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-INVFLTYP-ERR'
...
#    And print 'createSelfServiceBulkThirdParty0 = \n', createSelfServiceBulkThirdParty0
    ...
    * def thirdPartyProcessId =                        createSelfServiceBulkThirdParty1_response.data.processId
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE: UPLOAD FLAT FILE - THIRD_PARTY_CONTACT_ADD_EDIT_DELETE - ADD'
    And print '******** nowMs                  = '+ nowMs
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorInvalidFileType.doc' )
    ...
    * def createSelfServiceBulkThirdPartyContacts = call read( "./call/createSelfServiceBulkThirdPartyContacts.feature" )   { "csvRowsT": "#(csvRowsT)", "processType": "THIRD_PARTY_CONTACT_ADD_EDIT_DELETE" }
...
#    And print "retrieveContactsSelfServiceProcess1_response =\n", retrieveContactsSelfServiceProcess1_response
    * def contactsStatus1 =                               retrieveContactsSelfServiceProcess1_response.data.status
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE CONTACTS: UPLOAD CSV FILE - THIRD_PARTY_CONTACT_ADD_EDIT_DELETE - ADD'
    And print '******** nowMs               = '+ nowMs
    And print '******** xTenantCode         = '+ xTenantCode
    And print '******** requestorEmail      = '+ requestorEmail
    And print '******** CONTACTS PROCESS ID = '+ contactsProcessId
...
#
          ...
          """
            {
              ...
              "data":    {
                             ...
                             "childReferenceId":    "##string",
                             "triggeredBy":         "#string",
                             "processType":         "THIRD_PARTY_CONTACT_ADD_EDIT_DELETE"
                         }
            }
          """
    ...
    * def validateContactsSuccess1 = ( retrieveContactsSelfServiceProcess1_response.data.recordProcessed==0 && retrieveContactsSelfServiceProcess1_response.data.recordWithErrors==1 )
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: UPLOAD CSV FILE - THIRD_PARTY_CONTACT_ADD_EDIT_DELETE - PARTUPDATE'
    And print '******** CONTACTS PROCESS ID       = '+ contactsProcessId
    And print '******** CONTACTS STATUS           = '+ contactsStatus1
