@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorExceedMaxNumOtherNames
...
# Success: 10 Other Names
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |          |           |            |            |              |    |      |               |Philippines|            |           |   |             |           |                    |MyFirm_01 |Other Name     |                  |                  |                     |              |                         |           |                |\n"
