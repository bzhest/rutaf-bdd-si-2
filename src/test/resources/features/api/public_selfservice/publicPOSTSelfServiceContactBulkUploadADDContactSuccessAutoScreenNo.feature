@api @public_api @postPublicSelfServiceContactBulkUploadADDContactSuccessAutoScreenNo
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-SUCC-AUTOSCRNO'
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactSuccessAutoScreenNo.csv' )
