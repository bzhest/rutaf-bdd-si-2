@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEErrorIncompleteBankDtls
...
#      """
  ...
  Scenario: 01) C37786719 Third-party - PARTUPDATE
                - Verify error for Incomplete Bank details

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) INCOMPLETE BANK DETAILS ERROR - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-INCBANKDTLS-ERR'
...
# ==================================================================================================================
# ======== Case-01) ERROR INCOMPLETE BANK DETAILS - Empty 'Bank Name' ==========
# ==================================================================================================================
#
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |           |11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|            |              |      |             |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
#    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shelleum    |Local Language Name|Canada            |                           |                        \n"
#    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shellack    |Local Language Name|Canada            |                           |                        \n"
...
# ==================================================================================================================
# ======== Case-02) ERROR INCOMPLETE BANK DETAILS - Empty 'Bank Address Line' ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
# Success: ADD thirdParty
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |MoneyBank01|                 |11111111   |Reno     |MB Reno Br.|United States|            |              |      |             |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
#    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shelleum    |Local Language Name|Canada            |                           |                        \n"
#    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shellack    |Local Language Name|Canada            |                           |                        \n"
...
# ==================================================================================================================
# ======== Case-03) ERROR INCOMPLETE BANK DETAILS - Empty 'Account No.' ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
# Success: ADD thirdParty
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |MoneyBank01|11 Finance Avenue|           |Reno     |MB Reno Br.|United States|            |              |      |             |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
#    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shelleum    |Local Language Name|Canada            |                           |                        \n"
#    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shellack    |Local Language Name|Canada            |                           |                        \n"
...
# ==================================================================================================================
# ======== Case-04) ERROR INCOMPLETE BANK DETAILS - Empty 'Bank City' ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
# Success: ADD thirdParty
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |MoneyBank01|11 Finance Avenue|11111111   |         |MB Reno Br.|United States|            |              |      |             |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
#    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shelleum    |Local Language Name|Canada            |                           |                        \n"
#    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shellack    |Local Language Name|Canada            |                           |                        \n"
...
# ==================================================================================================================
# ======== Case-05) ERROR INCOMPLETE BANK DETAILS - Empty 'Branch Name' ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
# Success: ADD thirdParty
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |MoneyBank01|11 Finance Avenue|11111111   |Reno     |           |United States|            |              |      |             |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
#    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shelleum    |Local Language Name|Canada            |                           |                        \n"
#    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shellack    |Local Language Name|Canada            |                           |                        \n"
...
# ==================================================================================================================
# ======== Case-06) ERROR INCOMPLETE BANK DETAILS - Empty 'Bank Country' ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
# Success: ADD thirdParty
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |02/02/1987           |       |02/02/2008      |           |                    |          |              |              |               |                |             |                       |                    |              |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|             |            |              |      |             |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
#    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shelleum    |Local Language Name|Canada            |                           |                        \n"
#    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |             |               |             |             |              |   |                |           |                    |Shellack    |Local Language Name|Canada            |                           |                        \n"
