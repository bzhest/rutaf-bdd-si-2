@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorDuplicateOtherNameValues
...
# Error: Duplicate 'Other Name'
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MayBank  |11 Finance Avenue|12345678   |Ont.     |MayBank Ont|United States|1 Maple Ave.|Toronto       |Ont.  |Americas|11111          |Canada     |111111      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme1 Inc.|Local Language Name|Vietnam           |Field1            |FULLUPDATE TEXT    |              |                         |           |                |\n"
    * def csvRows02 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |         |                 |           |         |           |             |2 Rizal Ave.|Metro Manila  |QC    |Asia    |22222          |Philippines|222222      |www.test2.com|456|test2@test.ph|           |                    |Acme1 Inc.|Local Language Name|                  |                  |                   |              |                         |           |                |\n"
