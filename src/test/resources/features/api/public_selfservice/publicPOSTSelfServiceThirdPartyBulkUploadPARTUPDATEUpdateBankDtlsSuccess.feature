@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateBankDtlsSuccess
...
#      """
  ...
  Scenario: 01) C37786728 Third-party - PARTUPDATE
                - Update Bank Details

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE BANK DETAILS SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-UPDBANKDTLS-SUCC'
...
#    * def description1 =        retrieveThirdPartyByIdResult1[0].response.data.description
    ...
    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]
    ...
    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( bank0Name == 'Bank Name' ) +'  bank0Name : ="'+ bank0Name +'"'
    And print '==================================================\n'
    And print '\n'
