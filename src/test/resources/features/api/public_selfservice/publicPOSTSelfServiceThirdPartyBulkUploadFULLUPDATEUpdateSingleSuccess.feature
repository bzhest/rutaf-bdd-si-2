@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEUpdateSingleSuccess
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Philippines|            |             |   |             |           |                    |          |                   |                  |                  |                   \n"
...
#   * def csvRows2 = "FULLUPDATE|xxxxxxxxxx||1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"

# Error: Non-existent 'referenceNo'
#   * def csvRows2 = "FULLUPDATE||qwerty1-xxx|1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"
