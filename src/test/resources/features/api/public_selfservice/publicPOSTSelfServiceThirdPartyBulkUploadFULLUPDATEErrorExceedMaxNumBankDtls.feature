@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorExceedNumMaxBankDtls
...
#   * def csvRows02 = "FULLUPDATE|61711a8c1f851700016d60ce|qwerty1|1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"

# Success: 10 Bank Details
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |MyBank_01|111 Main Ave.    |1111111111 |SJ_City_01|Branch_01  |Philippines |            |              |    |      |               |Philippines|            |       |   |             |           |                    |          |               |                  |                  |                     |              |                         |           |                |\n"
