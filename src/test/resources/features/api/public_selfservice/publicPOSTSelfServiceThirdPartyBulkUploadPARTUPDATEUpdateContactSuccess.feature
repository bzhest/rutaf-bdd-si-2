@api @public_api @publicPOSTSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateContactSuccess
...
#      """
  ...
  Scenario: 01) C37786730 Third-party - PARTUPDATE
                - Update Contact Information section

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE THIRD-PARTY CONTACT SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-CONTACT-SUCC'
...
#    And print '\n'
    ...
    * def email1 =       retrieveThirdPartyByIdResult1[0].response.data.contactInformation.email[0]
    * def fax1 =         retrieveThirdPartyByIdResult1[0].response.data.contactInformation.fax[0]
    * def phoneNumber1 = retrieveThirdPartyByIdResult1[0].response.data.contactInformation.phoneNumber[0]
    * def website1 =     retrieveThirdPartyByIdResult1[0].response.data.contactInformation.website[0]

#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     email       :    VALUE ="'+ email1 +'"'
    And print 'VALIDATE email       :    MATCH ='+ ( email1 == 'john.smith@company1.com' )
    And print ''
    And print 'TEST     phoneNumber :    VALUE ="'+ phoneNumber1 +'"'
    And print 'VALIDATE phoneNumber :    MATCH ='+ ( phoneNumber1 == '1234567890' )
    And print '==================================================\n'
    And print '\n'

    And match email1 ==       'john.smith@company1.com'
    And match phoneNumber1 == '123-456-7890'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme Inc.   |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    ...
    * def csvRows02 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                                |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |180022222222|www.test02.com|222|test02@test.com |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
...
#    And match otherNamesCount == VALIDATECOUNT
    ...
    * def email2 =       retrieveThirdPartyByIdResult2[0].response.data.contactInformation.email[ 0 ]
    * def fax2 =         retrieveThirdPartyByIdResult2[0].response.data.contactInformation.fax[ 0 ]
    * def phoneNumber2 = retrieveThirdPartyByIdResult2[0].response.data.contactInformation.phoneNumber[ 0 ]
    * def website2 =     retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website[ 0 ]

    * def emailCount =   retrieveThirdPartyByIdResult2[0].response.data.contactInformation.email.length
    * def email2b =      retrieveThirdPartyByIdResult2[0].response.data.contactInformation.email[ emailCount-1 ]
...
#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]
    ...
    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     email       :    VALUE ="'+  email2 +'"'
    And print 'VALIDATE email       :    MATCH ='+ ( email2 == 'test01@test.com' )
    And print ''
    And print 'TEST     fax         :    VALUE ="'+  fax2 +'"'
    And print 'VALIDATE fax         :    MATCH ='+ ( fax2 == '111' )
    And print ''
    And print 'TEST     phoneNumber :    VALUE ="'+  phoneNumber2 +'"'
    And print 'VALIDATE phoneNumber :    MATCH ='+ ( phoneNumber2 == '+180011111111' )
    And print ''
    And print 'TEST     website     :    VALUE ="'+  website2 +'"'
    And print 'VALIDATE website     :    MATCH ='+ ( website2 == 'www.test01.com' )
    And print ''
    And print 'TEST     email.count :    VALUE ="'+  emailCount +'"'
    And print 'VALIDATE email.count :    MATCH ='+ ( emailCount == 2 )
    And print '==================================================\n'
    And print '\n'

    And match email2 ==       'test01@test.com'
    And match fax2 ==         '111'
    And match phoneNumber2 == '180011111111'
    And match website2 ==     'www.test01.com'

    And match emailCount ==   2
    And match email2b ==      'test02@test.com'
