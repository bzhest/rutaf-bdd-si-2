@api @public_api @postPublicSelfServiceThirdPartyBulkUploadADDThirdPartyErrorExceedMaxLength
...
#      """
  ...
  Scenario: 47) C37786659 Third-party - ADD
    ...
    * def nowMs = call fnGetNowMs
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) ADD EXCEED MAX LENGTH ERROR'
