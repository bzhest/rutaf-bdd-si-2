@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateAddressSuccess
...
#      """
  ...
  Scenario: 01) C37786727 Third-party - PARTUPDATE
                - Successfully update a third-party (single line)

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE THIRD-PARTY SINGLE SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-ADDRESS-SUCC'
...
#    And print '\n'
    ...
    * def addressLine1 = retrieveThirdPartyByIdResult1[0].response.data.address.addressLine
    * def city1 =        retrieveThirdPartyByIdResult1[0].response.data.address.city
    * def postalCode1 =  retrieveThirdPartyByIdResult1[0].response.data.address.postalCode
    * def province1 =    retrieveThirdPartyByIdResult1[0].response.data.address.province

#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     addressLine :    VALUE ="'+  addressLine1 +'"'
    And print 'VALIDATE addressLine :    MATCH ='+ ( addressLine1 == 'Address Line 1' )
    And print ''
    And print 'TEST     city        :    VALUE ="'+  city1 +'"'
    And print 'VALIDATE city        :    MATCH ='+ ( city1 == 'City 1' )
    And print ''
    And print 'TEST     postalCode  :    VALUE ="'+  postalCode1 +'"'
    And print 'VALIDATE postalCode  :    MATCH ='+ ( postalCode1 == '31080' )
    And print ''
    And print 'TEST     province    :    VALUE ="'+  province1 +'"'
    And print 'VALIDATE province    :    MATCH ='+ ( province1 == 'Province 1' )
    And print '==================================================\n'
    And print '\n'

    And match addressLine1 == 'Address Line 1'
    And match city1 ==        'City 1'
    And match postalCode1 ==  '31080'
    And match province1 ==    'Province 1'
...
#    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def addressLine2 = retrieveThirdPartyByIdResult2[0].response.data.address.addressLine
    * def city2 =        retrieveThirdPartyByIdResult2[0].response.data.address.city
    * def postalCode2 =  retrieveThirdPartyByIdResult2[0].response.data.address.postalCode
    * def province2 =    retrieveThirdPartyByIdResult2[0].response.data.address.province

#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     addressLine :    VALUE ="'+  addressLine2 +'"'
    And print 'VALIDATE addressLine :    MATCH ='+ ( addressLine2 == '11 Main Ave.' )
    And print ''
    And print 'TEST     city        :    VALUE ="'+  city2 +'"'
    And print 'VALIDATE city        :    MATCH ='+ ( city2 == 'Ottawa' )
    And print ''
    And print 'TEST     postalCode  :    VALUE ="'+  postalCode2 +'"'
    And print 'VALIDATE postalCode  :    MATCH ='+ ( postalCode2 == 'ZIP90210' )
    And print ''
    And print 'TEST     province    :    VALUE ="'+  province2 +'"'
    And print 'VALIDATE province    :    MATCH ='+ ( province2 == 'Ontario' )
    And print '==================================================\n'
    And print '\n'

    And match addressLine2 == '11 Main Ave.'
    And match city2 ==        'Ottawa'
    And match postalCode2 ==  'ZIP90210'
    And match province2 ==    'Ontario'
#    And match customField_Field1[0].value == null
# ================================================================================
# ================================================================================
