@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEErrorExceedMaxNumOtherNames
...
#      """
  ...
  Scenario: 01) C37786722 Third-party - PARTUPDATE
                - Verify error for Maximum number of Other Names exceeded

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) EXCEED MAX NUM OTHER NAMES ERROR - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-MAXNUMOTHRNAMES-ERR'
...
#    And print '\n'
    ...
    * def otherNames0Name1 =  retrieveThirdPartyByIdResult1[0].response.data.otherNames[0].name
    * def otherNamesLength1 = retrieveThirdPartyByIdResult1[0].response.data.otherNames.length

    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( otherNamesLength1 == 1 )          +'  COUNT            ="'+ otherNamesLength1 +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames0Name1  == 'Shellack' ) +'  otherNames0Name1 ="'+ otherNames0Name1  +'"'
    And print '==================================================\n'
    And print '\n'
...
# ==================================================================================================================
# ======== Case-01) UPDATE MAX NUM OTHER NAMES - 10 rows: Success ==========
# ==================================================================================================================
#
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas/Asia|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc. |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Petronas      |Former Name        |Malaysia          |                           |                        |              |                         |           |                |\n"
    * def csvRows02 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |PTT           |Former Name        |Thailand          |                           |                        |              |                         |           |                |\n"
    * def csvRows03 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Petrovietnam  |Other Name         |Vietnam           |                           |                        |              |                         |           |                |\n"
    * def csvRows04 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Kampuchea Tela|Doing Business As  |Cambodia          |                           |                        |              |                         |           |                |\n"
    * def csvRows05 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |CNOOC         |Subsidiary         |China             |                           |                        |              |                         |           |                |\n"
    * def csvRows06 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Woodside      |Local Language Name|Australia         |                           |                        |              |                         |           |                |\n"
    * def csvRows07 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Eni           |Other Name         |Italy             |                           |                        |              |                         |           |                |\n"
    * def csvRows08 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |PetroSA       |Doing Business As  |South Africa      |                           |                        |              |                         |           |                |\n"
    * def csvRows09 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Total         |Subsidiary         |France            |                           |                        |              |                         |           |                |\n"
    * def csvRows10 = "           |                        |                |PON01   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Shell         |Local Language Name|United Kingdom    |                           |                        |              |                         |           |                |\n"
...
#    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def otherNames0name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[0].name
    * def otherNames1name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[1].name
    * def otherNames2name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[2].name
    * def otherNames3name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[3].name
    * def otherNames4name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[4].name
    * def otherNames5name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[5].name
    * def otherNames6name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[6].name
    * def otherNames7name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[7].name
    * def otherNames8name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[8].name
    * def otherNames9name2 =    retrieveThirdPartyByIdResult2[0].response.data.otherNames[9].name

    * def otherNamesLength2 =   retrieveThirdPartyByIdResult2[0].response.data.otherNames.length
#
##    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( otherNamesLength2 == 10              )  +'  COUNT            ="'+ otherNamesLength2 +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames0name2 == 'Petronas'       )  +'  otherNames0name2 ="'+ otherNames0name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames1name2 == 'PTT'            )  +'  otherNames1name2 ="'+ otherNames1name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames2name2 == 'Petrovietnam'   )  +'  otherNames2name2 ="'+ otherNames2name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames3name2 == 'Kampuchea Tela' )  +'  otherNames3name2 ="'+ otherNames3name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames4name2 == 'CNOOC'          )  +'  otherNames4name2 ="'+ otherNames4name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames5name2 == 'Woodside'       )  +'  otherNames5name2 ="'+ otherNames5name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames6name2 == 'Eni'            )  +'  otherNames6name2 ="'+ otherNames6name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames7name2 == 'PetroSA'        )  +'  otherNames7name2 ="'+ otherNames7name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames8name2 == 'Total'          )  +'  otherNames8name2 ="'+ otherNames8name2  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames9name2 == 'Shell'          )  +'  otherNames9name2 ="'+ otherNames9name2  +'"'
    And print '==================================================\n'
    And print '\n'
...
# ==================================================================================================================
# ======== Case-02) EXCEED MAX NUM OTHR NAMES - 11 rows: Error ==========
# ==================================================================================================================
#
# SELF-SERVICE PARTUPDATE third-party: by BULK-UPLOAD
#
...
# Success: ADD thirdParty
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI/ADA      |PRS/PRA          |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada/China |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme01 Inc.    |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |1800111111111|              |111|                |           |                    |PetronasX      |Former Name        |Malaysia          |                           |                        |              |                         |           |                |\n"
    * def csvRows02 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |PTTX           |Former Name        |Thailand          |                           |                        |              |                         |           |                |\n"
    * def csvRows03 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |PetrovietnamX  |Other Name         |Vietnam           |                           |                        |              |                         |           |                |\n"
    * def csvRows04 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |Kampuchea TelaX|Doing Business As  |Cambodia          |                           |                        |              |                         |           |                |\n"
    * def csvRows05 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |CNOOCX         |Subsidiary         |China             |                           |                        |              |                         |           |                |\n"
    * def csvRows06 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |WoodsideX      |Local Language Name|Australia         |                           |                        |              |                         |           |                |\n"
    * def csvRows07 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |EniX           |Other Name         |Italy             |                           |                        |              |                         |           |                |\n"
    * def csvRows08 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |PetroSAX       |Doing Business As  |South Africa      |                           |                        |              |                         |           |                |\n"
    * def csvRows09 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |TotalX         |Subsidiary         |France            |                           |                        |              |                         |           |                |\n"
    * def csvRows10 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |ShellX         |Local Language Name|United Kingdom    |                           |                        |              |                         |           |                |\n"
    * def csvRows11 = "           |                        |                |PON02   |                           |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |ShellX         |Local Language Name|United Kingdom    |                           |                        |              |                         |           |                |\n"
...
##    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def otherNames0name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[0].name
    * def otherNames1name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[1].name
    * def otherNames2name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[2].name
    * def otherNames3name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[3].name
    * def otherNames4name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[4].name
    * def otherNames5name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[5].name
    * def otherNames6name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[6].name
    * def otherNames7name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[7].name
    * def otherNames8name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[8].name
    * def otherNames9name3 =    retrieveThirdPartyByIdResult3[0].response.data.otherNames[9].name

    * def otherNamesLength3 =   retrieveThirdPartyByIdResult3[0].response.data.otherNames.length
#
##    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( otherNamesLength3 == 10              )  +'  COUNT            ="'+ otherNamesLength3 +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames0name3 == 'Petronas'       )  +'  otherNames0name3 ="'+ otherNames0name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames1name3 == 'PTT'            )  +'  otherNames1name3 ="'+ otherNames1name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames2name3 == 'Petrovietnam'   )  +'  otherNames2name3 ="'+ otherNames2name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames3name3 == 'Kampuchea Tela' )  +'  otherNames3name3 ="'+ otherNames3name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames4name3 == 'CNOOC'          )  +'  otherNames4name3 ="'+ otherNames4name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames5name3 == 'Woodside'       )  +'  otherNames5name3 ="'+ otherNames5name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames6name3 == 'Eni'            )  +'  otherNames6name3 ="'+ otherNames6name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames7name3 == 'PetroSA'        )  +'  otherNames7name3 ="'+ otherNames7name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames8name3 == 'Total'          )  +'  otherNames8name3 ="'+ otherNames8name3  +'"'
    And print 'VALIDATE MATCH ='+ ( otherNames9name3 == 'Shell'          )  +'  otherNames9name3 ="'+ otherNames9name3  +'"'
    And print '==================================================\n'
    And print '\n'
