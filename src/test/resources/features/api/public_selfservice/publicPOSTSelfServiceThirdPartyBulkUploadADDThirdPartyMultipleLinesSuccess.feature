@api @public_api @postPublicSelfServiceThirdPartyBulkUploadADDThirdPartyMultipleLinesSuccess
...
#      """
  ...
  Scenario: 36) C37786683 Third-party - ADD
    ...
    * def nowMs = call fnGetNowMs
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) ADD MULTIPLE SUCCESS'
    And print '******** nowMs = '+ nowMs
    And print '================================\n'
    And print '\n'

    * def nameVarTARGET =       'ADD-3P-MULTILINE-SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs    +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|Z1234          |Canada     |+18001      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme Inc. |Local Language Name|France            |Field1            |FULLUPDATE TEXT       \n"
    * def csvRows01 = "ADD        |                        |"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|11 Finance Avenue|11111111111|Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP11111       |Canada     |001800111111|www.test1.com|111|tst@email.com|Desc0123abc|                    |Acme01Corp|Local Language Name|France            |Field1            |Test CUSTOM Field1 VAL|              |                         |           |                |\n"
    * def csvRows02 = "           |                        |"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |                                |MyDivision|              |              |               |                |             |                       |                    |              |ForteBank|22 Finance Avenue|22222222222|Chicago  |FB Chi. Br.|United States|22 Main Ave.|Brit.Columbia |Victor|Americas|ZIP22222       |Canada     |001800222222|www.test2.com|222|tst2@email.ca|           |                    |Acme02Corp|Local Language Name|United States     |                  |                      |              |                         |           |                |\n"
    * def csvRows03 = "           |                        |                |1       |                           |            |        |                 |             |                 |                     |       |                |           |                                |          |              |              |               |                |             |                       |                    |              |AltusBank|33 Finance Avenue|33333333333|Charlotte|AB Cha. Br.|United States|33 Main Ave.|Nova Scotia   |Halifx|Americas|ZIP33333       |Canada     |001800333333|www.test3.com|   |             |           |                    |Acme03Corp|Local Language Name|Argentina         |                  |                      |              |                         |           |                |\n"
