@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEUpdateDescriptionSuccess
...
#   * def csvRows1 = "FULLUPDATE |61711a8c1f851700016d60ce|qwerty1         |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Philippines|            |       |   |             |           |                    |          |               |                  |                  |                     "

# Success: Update Description
    * def csvRows01 = "FULLUPDATE |"+ thirdPartyId       +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                |           |          |            |            |           |             |     |       |              |Canada     |            |       |   |             |This is OK.|                    |          |               |                  |                  |                   |              |                         |           |                |\n"

# Success: reference no.
#   * def csvRows1 = "FULLUPDATE||qwerty1|1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"

# Success: thirdParty id
#   * def csvRows1 = "FULLUPDATE|61711a8c1f851700016d60ce|qwerty1|1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"

# Error: Non-existent 'thirdParty id'
#   * def csvRows1 = "FULLUPDATE|xxxxxxxxxx||1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"

# Error: Non-existent 'referenceNo'
#   * def csvRows1 = "FULLUPDATE||qwerty1-xxx|1|FULLUPDATE - "+ nowMs +"||||||||||rddcentre.admin.np@refinitiv.com|MyDivision|Default|||||||||||||||||||Philippines|||||||||||"
