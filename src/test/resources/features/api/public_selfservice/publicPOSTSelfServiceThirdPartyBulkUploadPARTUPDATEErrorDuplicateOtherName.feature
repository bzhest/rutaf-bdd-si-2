@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEErrorDuplicateOtherName
...
#      """
  ...
  Scenario: 01) C37786718 Third-party - PARTUPDATE
                - Verify error Other Name that already exists

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) DUPLICATE OTHER NAME ERROR - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-DUPLOTHRNAME-ERR'
      ...
      """
          {
            ...
            "businessType": "PRS",
            "incorporationDate": "2002-06-18T05:32:07-0800",
            "revenue": "10M",
