@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEUpdateAddressSuccess
...
# Success: Update Address
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                |           |          |            |            |1 Main Ave.|Rizal         |Bay  |Asia |90210          |Philippines |            |       |   |             |           |                    |          |               |                  |                  |                     |              |                         |           |                |\n"
