@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateOtherInfoSuccess
...
#      """
  ...
  Scenario: 01) C37786733 Third-party - PARTUPDATE
                - Update Other Information section

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE THIRD-PARTY OTHER INFO SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-OTHRINFO-SUCC'
