@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateDescSuccess
...
#      """
  ...
  Scenario: 01) C37786735 Third-party - PARTUPDATE
                - Update Description

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE THIRD-PARTY DESCRIPTION SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-DESC-SUCC'
