@api @public_api @postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength
Feature: Bulk Upload to Third Party Contacts
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-EXCDMAXLEN-ERR'
...
#
    ...
    * def retrieveThirdPartySelfServiceProcess1 =           call read( "./call/retrieveSelfServiceBulkThirdPartyProcessDetailsById.feature" )   { "processId": "#(thirdPartyProcessId)" }
...
### #####################################################################################################################
# 1) Exceed max. length: 'Contact First Name' 64 chars.
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_nameFirst64.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1011) )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1012) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1013) )

    * def createSelfServiceBulkThirdPartyContacts = call read( "./call/createSelfServiceBulkThirdPartyContacts.feature" )   { "csvRowsT": "#(csvRowsT)", "processType": "THIRD_PARTY_ASSOCIATED_INDIVIDUALS_ADD_UPDATE_DELETE" }
...
#
    ...
    * def retrieveContactsSelfServiceProcess1 =           call read( "./call/retrieveSelfServiceBulkThirdPartyProcessDetailsById.feature" )   { "processId": "#(contactsProcessId)" }
...
#
    ...
    * def validateContactsSuccess1 = ( retrieveContactsSelfServiceProcess1_response.data.recordProcessed==1 && retrieveContactsSelfServiceProcess1_response.data.recordWithErrors==1 )
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_nameFirst65.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1014) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1015) )
...
#
    ...
    * def validateContactsSuccess1 = ( retrieveContactsSelfServiceProcess1_response.data.recordProcessed==0 && retrieveContactsSelfServiceProcess1_response.data.recordWithErrors==1 )
...
### #####################################################################################################################
# 2) Exceed max. length: 'Contact Last Name' 64 chars.
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_nameLast64.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1021) )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1022) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1023) )
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_nameLast65.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1024) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1025) )
...
### #####################################################################################################################
# 3) Exceed max. length: 'Contact Middle Name' 64 chars.
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_nameMiddle64.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1031) )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1032) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1033) )
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_nameMiddle65.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1034) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1035) )
...
### #####################################################################################################################
# 4) Exceed max. length: 'Title' 64 chars.
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_title64.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1041) )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1042) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1043) )
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_title65.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1044) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1045) )
...
### #####################################################################################################################
# 5) Exceed max. length: 'Address Line' 64 chars.
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_addressLine64.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1051) )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1052) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1053) )
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorExceedMaxLength_addressLine65.csv' )
    * def csvAsString = replacePlaceholderString( csvAsString, '[THIRD-PARTY-ID]',   ''+thirdPartyId )
    * def csvAsString = replacePlaceholderString( csvAsString, '[CONTACT-REF-ID]',   ''+(nowMs+1054) )
    * def csvRowsT =    replacePlaceholderString( csvAsString, '[CONTACT-EMAIL-MS]', ''+(nowMs+1055) )
