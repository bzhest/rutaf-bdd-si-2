@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateSegmentationSuccess
...
#      """
  ...
  Scenario: 01) C37786732 Third-party - PARTUPDATE
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-SEGMTN-SUCC'
...
#    And print '\n'
    ...
    * def relationshipVisibility1 = retrieveThirdPartyByIdResult1[0].response.data.relationshipVisibility
    * def commodityType1 =          retrieveThirdPartyByIdResult1[0].response.data.commodityType
...
#    And match otherNamesCount == VALIDATECOUNT
    ...
    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     relationshipVisibility :    VALUE ="'+  relationshipVisibility1 +'"'
    And print 'VALIDATE relationshipVisibility :    MATCH ='+ ( relationshipVisibility1 == 'LITTLE_VIS' )
    And print ''
    And print 'TEST     commodityType          :    VALUE ="'+  commodityType1 +'"'
    And print 'VALIDATE commodityType          :    MATCH ='+ ( commodityType1 == 'A3P' )
    And print '==================================================\n'
    And print '\n'

    And match relationshipVisibility1 == 'LITTLE_VIS'
    And match commodityType1 == 'A3P'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme Inc.   |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |OEM_REBRANDED          |COMMODITIZED_PRODUCT|ACS           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |180011111111|www.test01.com|111|test01@test.com |Desc abc111|                    |Acme01 Inc. |Local Language Name|                  |Field1                     |PARTUPDATE TEXT         |              |                         |           |                |\n"
#    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"||1       |"+nameVarTARGET+"-"+nowMs+"|||||||||||||OTS|DIST_M_SRC|OTS|MULTI|LITTLE_VIS|COMMODITIZED_PRODUCT|A3P|||||||||||||||||||||||\n"
...
#    And print 'retrieveThirdPartyByIdResult2 = \n', retrieveThirdPartyByIdResult2
    ...
    * def relationshipVisibility2 = retrieveThirdPartyByIdResult2[0].response.data.relationshipVisibility
    * def commodityType2 =          retrieveThirdPartyByIdResult2[0].response.data.commodityType
...
#    And match otherNamesCount == VALIDATECOUNT
    ...
    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     relationshipVisibility :    VALUE ="'+  relationshipVisibility2 +'"'
    And print 'VALIDATE relationshipVisibility :    MATCH ='+ ( relationshipVisibility2 == 'OEM_REBRANDED' )
    And print ''
    And print 'TEST     commodityType          :    VALUE ="'+  commodityType2 +'"'
    And print 'VALIDATE commodityType          :    MATCH ='+ ( commodityType2 == 'ACS' )
    And print '==================================================\n'
    And print '\n'

    And match relationshipVisibility2 == 'OEM_REBRANDED'
    And match commodityType2 ==          'ACS'
# ================================================================================
# ================================================================================
