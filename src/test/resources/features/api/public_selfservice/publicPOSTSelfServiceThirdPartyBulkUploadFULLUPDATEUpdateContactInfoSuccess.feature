@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEUpdateContactInfoSuccess
...
# Success: Contact Information
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Philippines|111111111111|www.test1.com|111|abc@test1.com|           |                    |          |               |                  |                  |                   |              |                         |           |                |\n"
