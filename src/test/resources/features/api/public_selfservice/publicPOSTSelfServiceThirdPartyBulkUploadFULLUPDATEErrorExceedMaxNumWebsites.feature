@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorExceedMaxNumWebsites
...
# Success: 5 Websites
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |          |           |            |            |              |    |      |               |Philippines|            |www.abc1.ph|   |             |           |                    |          |               |                  |                  |                     |              |                         |           |                |\n"
