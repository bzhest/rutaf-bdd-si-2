@api @public_api @postPublicSelfServiceThirdPartyBulkUploadADDThirdParty3Error2Success
...
#      """
  ...
  Scenario: 44) C37786691 Third-party - ADD
    ...
    * def nowMs = call fnGetNowMs
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) ADD 3 ERROR 2 SUCCESS'
    And print '******** nowMs = '+ nowMs
    And print '================================\n'
    And print '\n'

    * def nameVarTARGET =       'ADD-3P-3ERR-2SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs    +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|12 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP902111111111|Canada       |180011111111|www.test01.com|111|email01@test.com|Desc abc123|                    |Acme01 Corp.|Local Language Name|France                  |Field1            |FULLUPDATE TEXT    \n"
    * def csvRows01 = "ADD        |                        |"+    nowMs   +"|001     |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP902111111111|Canada       |180011111111|www.test01.com|111|email01@test.com|Test desc01|                    |Acme01 Corp.|Local Language Name|France                  |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows02 = "ADD        |                        |                |002     |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |01/11/2001           |10M    |02/22/2002      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank02|22 Finance Avenue|22222222   |NYC      |MB NYC Br. |United States|22 Main Ave.|              |Jersey|Americas|ZIP902222222222|United States|180022222222|www.test02.com|222|email02@test.com|Test desc02|                    |Acme02 Corp.|Local Language Name|Italy                   |Field1            |Test CUSTOMFLD VAL2|              |                         |           |                |\n"
    * def csvRows03 = "ADD        |                        |                |003     |"+nameVarTARGET+"-"+nowMs+"|            |        |XXXXXXXXXXXXXXXXX|             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|XXXXXXXXXX|Default       |              |               |XXXXXXXXXXXXXXXX|             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |              |   |                |           |                    |            |                   |                        |                  |                   |              |                         |           |                |\n"
    * def csvRows04 = "ADD        |                        |                |004     |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |XXXXXXXXXXXXX|                 |                     |XXXXXXX|                |           |                                |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |              |   |                |           |                    |            |                   |                        |                  |                   |              |                         |           |                |\n"
    * def csvRows05 = "ADD        |                        |                |005     |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |XXXXXXXXXXXXXXXXX|                     |       |                |           |                                |          |              |XXXXXXXXXXXXXX|               |                |             |XXXXXXXXXXXXXXXXXXXXXXX|                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |              |   |                |           |                    |            |                   |                        |                  |                   |              |                         |           |                |\n"
...
#
    ...
    * def validateSuccess1 = ( retrieveSelfServiceProcess1_response.data.recordProcessed==2 && retrieveSelfServiceProcess1_response.data.recordWithErrors==3 )
