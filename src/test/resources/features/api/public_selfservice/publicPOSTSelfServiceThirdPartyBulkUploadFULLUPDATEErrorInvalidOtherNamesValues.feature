@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorInvalidOtherNamesValues
...
#   * def csvRows01 = "FULLUPDATE |61711a8c1f851700016d60ce|qwerty1         |1       |FULLUPDATE - "+ nowMs +"|CORP        |USD     |5K-10K           |AHI          |MIL              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com    |MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MayBank  |11 Finance Avenue|12345678   |Ont.     |MayBank Ont|United States|1 Maple Ave.|Toronto       |Ont.  |Americas|11111          |Canada     |111111      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme1 Inc.|Local Language Name|Vietnam           |Field1            |FULLUPDATE TEXT    \n"
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULUPD-ONMS-INV"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com    |MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Philippines|            |             |   |             |           |                    |Acme1 Inc.|XXXXXXXX           |XXXXXXXX          |                  |                   |              |                         |           |                |\n"
