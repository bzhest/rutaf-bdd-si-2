@api @public_api @postPublicSelfServiceThirdPartyBulkUploadDELETEThirdParty5Success
...
#      """
  ...
  Scenario: 01) C37797273 Third-party - DELETE
                - Delete five third-party

    * def nowMs01 = call fnGetNowMs

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) DELETE 5 THIRD-PARTIES SUCCESS - DELETE'
...
#
    ...
    * def nameVarTARGET =       'DEL-3P-5-SUCC'
...
#
    ...
    * def validateSuccess2 = ( retrieveSelfServiceProcess2_response.data.recordProcessed==5 && retrieveSelfServiceProcess2_response.data.recordWithErrors==0 )
