@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateGenInfoSuccess
...
#      """
  ...
  Scenario: 01) C37786731 Third-party - PARTUPDATE
                - Update General Information section

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE THIRD-PARTY GEN. INFO. SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-GENINFO-SUCC'
...
#    And print '\n'
    ...
    * def currency1 =         retrieveThirdPartyByIdResult1[0].response.data.currency
    * def responsibleParty1 = retrieveThirdPartyByIdResult1[0].response.data.responsibleParty

#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     currency         :    VALUE ="'+ currency1 +'"'
    And print 'VALIDATE currency         :    MATCH ='+ ( currency1 == 'USD' )
    And print ''
    And print 'TEST     responsibleParty :    VALUE ="'+ responsibleParty1 +'"'
    And print 'VALIDATE responsibleParty :    MATCH ='+ ( responsibleParty1 == 'rddcentre.admin.np@refinitiv.com' )
    And print '==================================================\n'
    And print '\n'

    And match currency1 ==         'USD'
    And match responsibleParty1 == 'rddcentre.admin.np@refinitiv.com'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme Inc.   |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"
    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|CORP        |CAD     |5K-10K           |AHI          |PRS              |02/22/1922            |10M    |11/11/2011      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|              |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |180011111111|www.test01.com|111|test01@test.com |Desc abc111|                    |Acme01 Inc. |Local Language Name|                  |Field1                     |PARTUPDATE TEXT         |              |                         |           |                |\n"
...
#    And match otherNamesCount == VALIDATECOUNT
    ...
    * def currency2 =         retrieveThirdPartyByIdResult2[0].response.data.currency
    * def responsibleParty2 = retrieveThirdPartyByIdResult2[0].response.data.responsibleParty

#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     currency         :    VALUE ="'+ currency2 +'"'
    And print 'VALIDATE currency         :    MATCH ='+ ( currency2 == 'CAD' )
    And print ''
    And print 'TEST     responsibleParty :    VALUE ="'+ responsibleParty2 +'"'
    And print 'VALIDATE responsibleParty :    MATCH ='+ ( responsibleParty2 == 'rddcentre.admin.np@refinitiv.com' )
    And print '==================================================\n'
    And print '\n'

    And match currency2 ==         'CAD'
    And match responsibleParty2 == 'rddcentre.admin.np@refinitiv.com'
# ================================================================================
# ================================================================================
