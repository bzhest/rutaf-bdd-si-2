@api @public_api @postPublicSelfServiceThirdPartyBulkUploadADDThirdParty10BankDtlsSuccess
...
#      """
  ...
  Scenario: 41) C37786684 Third-party - ADD
    ...
    * def nowMs = call fnGetNowMs
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) ADD 10 BANK DETAILS SUCCESS'
    And print '******** nowMs = '+ nowMs
    And print '================================\n'
    And print '\n'

    * def nameVarTARGET =       'ADD-3P-10BANKDTLS-SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs    +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|Z1234          |Canada       |+18001      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme Inc. |Local Language Name|France            |Field1            |FULLUPDATE TEXT    \n"
    * def csvRows01 = "ADD        |                        |"+    nowMs   +"|D01     |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|01 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |0018001     |www.test1.com|111|tst@email.com|Test desc. |                    |Acme Corp.|Local Language Name|France            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows02 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank02|02 Finance Avenue|22222222   |NYC      |NY Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows03 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank03|03 Finance Avenue|33333333   |LA       |LA Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows04 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank04|04 Finance Avenue|44444444   |Atlanta  |At.Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows05 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank05|05 Finance Avenue|55555555   |Detroit  |De.Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows06 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank06|06 Finance Avenue|66666666   |Sacrament|Sa.Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows07 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank07|07 Finance Avenue|77777777   |Milwaukee|Mi.Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows08 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank08|08 Finance Avenue|88888888   |SnAntonio|SA Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows09 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank09|09 Finance Avenue|99999999   |Austin   |Au.Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows10 = "           |                        |                |D01     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |MoneyBank10|10 Finance Avenue|10101010   |Indiana  |In.Reno Br.|United States|            |              |      |        |               |             |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
...
#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]
    * def bankDetails_LENGTH =   retrieveThirdPartyByIdResult1[0].response.data.bankDetails.length
    And match bankDetails_LENGTH == 10

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'bankDetails_LENGTH = "'+ bankDetails_LENGTH +'"'
    And print '==================================================\n'
    And print '\n'
