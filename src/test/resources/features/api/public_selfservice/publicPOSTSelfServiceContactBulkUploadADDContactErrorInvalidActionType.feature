@api @public_api @postPublicSelfServiceContactBulkUploadADDContactErrorInvalidActionType
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-INVACTTYP-ERR'
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorInvalidActionType.csv' )
