@api @public_api @postPublicSelfServiceThirdPartyBulkUploadDELETEThirdParty10Success
Feature: Bulk Upload DELETE Third Party
...
#      """
  ...
  Scenario: 01) C37797274 Third-party - DELETE
                - Delete 10 third-party

    * def nowMs01 = call fnGetNowMs

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) DELETE 10 THIRD-PARTIES SUCCESS - DELETE'
...
#
    ...
    * def nameVarTARGET =       'DEL-3P-10-SUCC'
...
################################################################################
    ...
    * def nowMs02 = call fnGetNowMs
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) DELETE THIRD-PARTY 10 SUCCESS - DELETE'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs +"   |CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |si_admin@yopmail.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc abc123|                    |Acme Inc.   |Local Language Name|France            |Field1                     |FULLUPDATE TEXT         \n"

    * def csvRows01 = "DELETE     |"+    thirdPartyId01   +"|               |1       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows02 = "DELETE     |"+    thirdPartyId02   +"|               |2       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows03 = "DELETE     |"+    thirdPartyId03   +"|               |3       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows04 = "DELETE     |"+    thirdPartyId04   +"|               |4       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows05 = "DELETE     |"+    thirdPartyId05   +"|               |5       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows06 = "DELETE     |"+    thirdPartyId06   +"|               |6       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows07 = "DELETE     |"+    thirdPartyId07   +"|               |7       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows08 = "DELETE     |"+    thirdPartyId08   +"|               |8       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows09 = "DELETE     |"+    thirdPartyId09   +"|               |9       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
    * def csvRows10 = "DELETE     |"+    thirdPartyId10   +"|               |A       |                           |            |        |                 |             |                 |                      |       |                |           |                    |          |              |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |             |              |   |                |           |                    |            |                   |                  |                           |                        |              |                         |           |                |\n"
...
###    * def deleteThirdPartyResult1 = cal                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                l read( "./call/deleteThirdParty.feature" ) thirdPartyIdsTODAYTARGETArr
    ...
    And print '\n'
    And print '======== VALIDATE ================================'
    And print "TEST  thirdPartyId='"+ thirdPartyId01 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId02 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId03 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId04 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId05 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId06 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId07 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId08 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId09 +"'"
    And print "TEST  thirdPartyId='"+ thirdPartyId10 +"'"
    And print '==================================================\n'
    And print '\n'
