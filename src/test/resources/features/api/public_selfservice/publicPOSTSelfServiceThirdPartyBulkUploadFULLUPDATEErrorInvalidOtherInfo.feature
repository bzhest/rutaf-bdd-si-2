@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorInvalidOtherInfo
...
#    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Philippines|            |           |   |             |           |                    |          |               |                  |Field1                     |FULLUPDATE - TEXT - "+ nowMs +"   \n"
...
#    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |12      |FULUPD-ONMSINVA"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Philippines|            |           |   |             |           |                    |          |               |                  |Field1                     |FULLUPDATE - TEXT - "+ nowMs +"   \n"
#    * def csvRows02 = "           |                        |                |12      |                        |            |        |                 |             |                 |                     |       |                |           |                    |          |              |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |           |            |           |   |             |           |                    |          |               |                  |Number field               |"+ nowMs +"                       \n"

    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULUPD-ONMSINVA"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Philippines|            |           |   |             |           |                    |          |               |                  |XXXXXXX"+ nowMs +"         |ABCXYZ"+ nowMs +"                 |              |                         |           |                |\n"
