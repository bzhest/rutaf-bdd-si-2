@api @public_api @postPublicSelfServiceContactBulkUploadADDContactErrorInvalidThirdPartyId
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-INV3PID-ERR'
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactErrorInvalidThirdPartyId.csv' )
