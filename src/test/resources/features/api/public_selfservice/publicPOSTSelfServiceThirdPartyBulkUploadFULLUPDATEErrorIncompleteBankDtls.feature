@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorIncompleteBankDtls
...
#   * def csvRows01 = "FULLUPDATE |61711a8c1f851700016d60ce|qwerty1         |1       |FULLUPDATE - "+ nowMs +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com    |MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |BN 1     |BA 1             |11111111   |BC 1     |BN1        |United States|1 Main Ave. |Nevada        |Reno  |Americas|11111          |Canada     |112233      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Dello     |Local Language Name|Vietnam           |Field1            |FULLUPDATE TEXT    \n"

#    * def csvRows01 = "FULLUPDATE |61711a8c1f851700016d60ce|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com    |MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |         |                 |           |         |           |             |            |              |      |        |               |Philippines|            |             |   |             |           |                    |          |                   |                  |                  |                   \n"
...
# Error: Incomplete bank details / 6191c4407387a87febdf276d
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |E8-INCBANKDTLS-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |AA1      |                 |4543       |         |           |             |            |              |      |        |               |Philippines|            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
