@api @public_api @postPublicSelfServiceThirdPartyBulkUploadDELETEThirdPartyErrorMissingFields
...
#      """
  ...
  Scenario: 01) C37797264  Third-party - DELETE - Verify error for Missing fields

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) DELETE THIRDPARTY MISSING FIELDS ERROR - DELETE'
...
#
    ...
    * def nameVarTARGET =       'DEL-3P-MISSINGFLDS-ERR'
...
# ================================================================================
#
# SELF-SERVICE DELETE third-party: by BULK-UPLOAD
#
