@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorExceedMaxNumPhoneNums
...
# Success: 5 Phone Numbers
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |          |           |            |            |              |    |      |               |Philippines|111111111111|           |   |             |           |                    |          |               |                  |                  |                     |              |                         |           |                |\n"
