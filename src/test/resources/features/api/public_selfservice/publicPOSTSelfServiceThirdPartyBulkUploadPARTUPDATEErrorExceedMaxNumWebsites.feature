@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEErrorExceedMaxNumWebsites
...
#      """
  ...
  Scenario: 01) C37786724 Third-party - PARTUPDATE
                - Verify error for Maximum number of Website exceeded

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) EXCEED MAX NUM WEBSITES ERROR - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-MAXNUMWEBSITES-ERR'
...
#    And print '\n'
    ...
    * def website01 =        retrieveThirdPartyByIdResult1[0].response.data.contactInformation.website[0]
    * def websiteLength1 =   retrieveThirdPartyByIdResult1[0].response.data.contactInformation.website.length

    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( websiteLength1 == 1 )                         +'  COUNT     ="'+ websiteLength1 +'"'
    And print 'VALIDATE MATCH ='+ ( website01      == 'http://www.company1.com' ) +'  website01 ="'+ website01      +'"'
    And print '==================================================\n'
    And print '\n'
...
# ==================================================================================================================
# ======== Case-01) UPDATE MAX NUM WEBSITES - 5 rows: Success ==========
# ==================================================================================================================
#
...
#    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def website02 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website[0]
    * def website12 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website[1]
    * def website22 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website[2]
    * def website32 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website[3]
    * def website42 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website[4]

    * def websiteLength2 =        retrieveThirdPartyByIdResult2[0].response.data.contactInformation.website.length
#
##    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( websiteLength2 == 5 )            +'  COUNT     ="'+ websiteLength2 +'"'
    And print 'VALIDATE MATCH ='+ ( website02 == 'www.test01.com' )  +'  website02 ="'+ website02 +'"'
    And print 'VALIDATE MATCH ='+ ( website12 == 'www.test02.com' )  +'  website12 ="'+ website12 +'"'
    And print 'VALIDATE MATCH ='+ ( website22 == 'www.test03.com' )  +'  website22 ="'+ website22 +'"'
    And print 'VALIDATE MATCH ='+ ( website32 == 'www.test04.com' )  +'  website32 ="'+ website32 +'"'
    And print 'VALIDATE MATCH ='+ ( website42 == 'www.test05.com' )  +'  website42 ="'+ website42 +'"'
    And print '==================================================\n'
    And print '\n'
...
##    And match customField_Field1[0].value == 'PARTUPDATE TEXT'
    ...
    * def website03 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.website[0]
    * def website13 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.website[1]
    * def website23 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.website[2]
    * def website33 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.website[3]
    * def website43 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.website[4]

    * def websiteLength3 =        retrieveThirdPartyByIdResult3[0].response.data.contactInformation.website.length
#
##    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'VALIDATE MATCH ='+ ( websiteLength3 == 5 )            +'  COUNT     ="'+ websiteLength3 +'"'
    And print 'VALIDATE MATCH ='+ ( website03 == 'www.test01.com' )  +'  website03 ="'+ website03      +'"'
    And print 'VALIDATE MATCH ='+ ( website13 == 'www.test02.com' )  +'  website13 ="'+ website13      +'"'
    And print 'VALIDATE MATCH ='+ ( website23 == 'www.test03.com' )  +'  website23 ="'+ website23      +'"'
    And print 'VALIDATE MATCH ='+ ( website33 == 'www.test04.com' )  +'  website33 ="'+ website33      +'"'
    And print 'VALIDATE MATCH ='+ ( website43 == 'www.test05.com' )  +'  website43 ="'+ website43      +'"'
    And print '==================================================\n'
    And print '\n'
