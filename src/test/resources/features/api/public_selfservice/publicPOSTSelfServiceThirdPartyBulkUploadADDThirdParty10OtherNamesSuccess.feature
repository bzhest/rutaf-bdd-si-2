@api @public_api @postPublicSelfServiceThirdPartyBulkUploadADDThirdParty10OtherNamesSuccess
...
#      """
  ...
  Scenario: 42) C37786685 Third-party - ADD
    ...
    * def nowMs = call fnGetNowMs
    ...
    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) ADD 10 OTHER NAMES SUCCESS'
    And print '******** nowMs = '+ nowMs
    And print '================================\n'
    And print '\n'

    * def nameVarTARGET =       'ADD-3P-10OTHERNAMES-SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs    +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|Z1234          |Canada       |+18001      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme Inc. |Local Language Name|France            |Field1            |FULLUPDATE TEXT    \n"
    * def csvRows01 = "ADD        |                        |"+    nowMs   +"|AV1     |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank01|01 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |0018001     |www.test1.com|111|tst@email.com|Test desc. |                    |Acme01 LLC|Local Language Name|Canada            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows02 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme02 LLC|Local Language Name|Italy             |                  |                   |              |                         |           |                |\n"
    * def csvRows03 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme03 LLC|Local Language Name|Argentina         |                  |                   |              |                         |           |                |\n"
    * def csvRows04 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme04 LLC|Local Language Name|United States     |                  |                   |              |                         |           |                |\n"
    * def csvRows05 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme05 LLC|Local Language Name|Philippines       |                  |                   |              |                         |           |                |\n"
    * def csvRows06 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme06 LLC|Local Language Name|Brazil            |                  |                   |              |                         |           |                |\n"
    * def csvRows07 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme07 LLC|Local Language Name|China             |                  |                   |              |                         |           |                |\n"
    * def csvRows08 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme08 LLC|Local Language Name|Malaysia          |                  |                   |              |                         |           |                |\n"
    * def csvRows09 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme09 LLC|Local Language Name|Spain             |                  |                   |              |                         |           |                |\n"
    * def csvRows10 = "           |                        |                |AV1     |                           |            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |           |                 |           |         |           |             |            |              |      |        |               |             |            |             |   |             |           |                    |Acme10 LLC|Local Language Name|South Africa      |                  |                   |              |                         |           |                |\n"
...
#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]
    * def otherNames_LENGTH =   retrieveThirdPartyByIdResult1[0].response.data.otherNames.length
    And match otherNames_LENGTH == 10

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'otherNames_LENGTH = "'+ otherNames_LENGTH +'"'
    And print '==================================================\n'
    And print '\n'
