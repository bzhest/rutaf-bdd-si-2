@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEErrorInvalidRegionCountryPair
...
# Error: Region and Country - Invalid pairing
    * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|                |1       |FULLUPDATE - "+ nowMs +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MayBank  |11 Finance Avenue|12345678   |Ont.     |MayBank Ont|United States|1 Maple Ave.|Toronto       |Ont.  |Asia     |11111          |Canada     |111111      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme1 Inc.|Local Language Name|Vietnam           |Field1            |FULLUPDATE TEXT    |              |                         |           |                |\n"
