@api @public_api @postPublicSelfServiceContactBulkUploadADDContactSuccessValid1
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-SUCC-VALID1'
...
#    * def csvRowsT = csvRows00 + csvRows01
    ...
    * def csvAsString = karate.readAsString( './data/postPublicSelfServiceContactBulkUploadADDContactSuccessValid1.csv' )
...
#
    ...
    * def validateContactsSuccess1 = ( retrieveContactsSelfServiceProcess1_response.data.recordProcessed==1 && retrieveContactsSelfServiceProcess1_response.data.recordWithErrors==0 )
