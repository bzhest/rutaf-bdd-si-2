@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATE3Error2Success
...
#    * def csvRows01 = "FULLUPDATE |61711a8c1f851700016d60ce|qwerty1         |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com    |MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |         |                 |           |         |           |             |            |              |      |        |               |Philippines|            |             |   |             |           |                    |          |                   |                  |                  |                   \n"
