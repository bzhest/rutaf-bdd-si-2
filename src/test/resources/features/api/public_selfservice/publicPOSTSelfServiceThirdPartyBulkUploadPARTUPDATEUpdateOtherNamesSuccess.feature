@api @public_api @postPublicSelfServiceThirdPartyBulkUploadPARTUPDATEUpdateOtherNamesSuccess
...
#      """
  ...
  Scenario: 01) C37786729 Third-party - PARTUPDATE
                - Update Other Names

    And print '\n'
    And print '================================'
    And print '******** SELF-SERVICE THIRD-PARTY: SCENARIO 01) UPDATE THIRD-PARTY OTHER NAMES SUCCESS - PARTUPDATE'
...
#
    ...
    * def nameVarTARGET =       'PUPD-3P-OTHRNAMES-SUCC'
...
#    * def customField_Field1 = $retrieveThirdPartyByIdResult1[0].response.data.customFields[ ?(@.name=='Field1') ]
    ...
    * def otherNames_count1 =                  retrieveThirdPartyByIdResult1[0].response.data.otherNames.length

    * def otherNames0_name1 =                  retrieveThirdPartyByIdResult1[0].response.data.otherNames[0].name
    * def otherNames0_iwNameType1 =            retrieveThirdPartyByIdResult1[0].response.data.otherNames[0].iwNameType
    * def otherNames0_countryOfRegistration1 = retrieveThirdPartyByIdResult1[0].response.data.otherNames[0].countryOfRegistration

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     otherNames0_name                  :    VALUE ="'+  otherNames0_name1 +'"'
    And print 'VALIDATE otherNames0_name                  :    MATCH ='+ ( otherNames0_name1 ==                  'Shellack' )
    And print ''
    And print 'TEST     otherNames0_iwNameType            :    VALUE ="'+  otherNames0_iwNameType1 +'"'
    And print 'VALIDATE otherNames0_iwNameType            :    MATCH ='+ ( otherNames0_iwNameType1 ==            'Local Language Name' )
    And print ''
    And print 'TEST     otherNames0_countryOfRegistration :    VALUE ="'+  otherNames_countryOfRegistration1 +'"'
    And print 'VALIDATE otherNames0_countryOfRegistration :    MATCH ='+ ( otherNames0_countryOfRegistration1 == 'CA' )
    And print '==================================================\n'
    And print '\n'

    And match otherNames_count1 ==                  1

    And match otherNames0_name1 ==                  'Shellack'
    And match otherNames0_iwNameType1 ==            'Local Language Name'
    And match otherNames0_countryOfRegistration1 == 'CA'
...
#    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|              |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc. abc11|Petronak Petrols   |Petronas      |Local Language Name|Malaysia          |Field1                     |PARTUPDATE TEXT         \n"
#    * def csvRows01 = "PARTUPDATE |"+    thirdPartyId1   +"|"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|              |MoneyBank01|11 Finance Avenue|11111111   |Reno     |MB Reno Br.|United States|11 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |+180011111111|www.test01.com|111|test01@test.com |Desc abc111|                    |Acme01 Inc.   |Local Language Name|                  |Field1                     |PARTUPDATE TEXT         \n"
...
#    And match otherNamesCount == VALIDATECOUNT
    ...
    * def otherNames_count2 =                  retrieveThirdPartyByIdResult2[0].response.data.otherNames.length

    * def otherNames0_name2 =                  retrieveThirdPartyByIdResult2[0].response.data.otherNames[0].name
    * def otherNames0_iwNameType2 =            retrieveThirdPartyByIdResult2[0].response.data.otherNames[0].iwNameType
    * def otherNames0_countryOfRegistration2 = retrieveThirdPartyByIdResult2[0].response.data.otherNames[0].countryOfRegistration

#    * def otherNamesX_name2 =                  retrieveThirdPartyByIdResult2[0].response.data.otherNames[X].name
#    * def otherNamesX_iwNameType2 =            retrieveThirdPartyByIdResult2[0].response.data.otherNames[X].iwNameType
#    * def otherNamesX_countryOfRegistration2 = retrieveThirdPartyByIdResult2[0].response.data.otherNames[X].countryOfRegistration

    * def otherNames9_name2 =                  retrieveThirdPartyByIdResult2[0].response.data.otherNames[9].name
    * def otherNames9_iwNameType2 =            retrieveThirdPartyByIdResult2[0].response.data.otherNames[9].iwNameType
    * def otherNames9_countryOfRegistration2 = retrieveThirdPartyByIdResult2[0].response.data.otherNames[9].countryOfRegistration

    And print '\n'
    And print '======== VALIDATE ================================'
    And print 'TEST     otherNames0_name                  :    MATCH='+ ( otherNames0_name2 ==                  'Petronas'            ) +' | VALUE="'+  otherNames0_name2                  +'"'
    And print 'TEST     otherNames0_iwNameType            :    MATCH='+ ( otherNames0_iwNameType2 ==            'Former Name'         ) +' | VALUE="'+  otherNames0_iwNameType2            +'"'
    And print 'TEST     otherNames0_countryOfRegistration :    MATCH='+ ( otherNames0_countryOfRegistration2 == 'MY'                  ) +' | VALUE="'+  otherNames0_countryOfRegistration2 +'"'
#    And print ''
#    And print 'TEST     otherNamesX_name                  :    MATCH='+ ( otherNamesX_name2 ==                  'XXX'                 ) +' | VALUE="'+  otherNamesX_name2                  +'"'
#    And print 'TEST     otherNamesX_iwNameType            :    MATCH='+ ( otherNamesX_iwNameType2 ==            'XXX'                 ) +' | VALUE="'+  otherNamesX_iwNameType2            +'"'
#    And print 'TEST     otherNamesX_countryOfRegistration :    MATCH='+ ( otherNamesX_countryOfRegistration2 == 'XXX'                 ) +' | VALUE="'+  otherNamesX_countryOfRegistration2 +'"'
    And print ''
    And print 'TEST     otherNames9_name                  :    MATCH='+ ( otherNames9_name2 ==                  'Shell'               ) +' | VALUE="'+  otherNames9_name2 +'"
    And print 'TEST     otherNames9_iwNameType            :    MATCH='+ ( otherNames9_iwNameType2 ==            'Local Language Name' ) +' | VALUE="'+  otherNames9_iwNameType2            +'"'
    And print 'TEST     otherNames9_countryOfRegistration :    MATCH='+ ( otherNames9_countryOfRegistration2 == 'GB'                  ) +' | VALUE="'+  otherNames9_countryOfRegistration2 +'"'
    And print '==================================================\n'
    And print '\n'

    And match otherNames_count2 ==                  10

    And match otherNames0_name2 ==                  'Petronas'
    And match otherNames0_iwNameType2 ==            'Former Name'
    And match otherNames0_countryOfRegistration2 == 'MY'

#    And match otherNamesX_name2 ==                  'XXX'
#    And match otherNamesX_iwNameType2 ==            'XXX'
#    And match otherNamesX_countryOfRegistration2 == 'XXX'

    And match otherNames9_name2 ==                  'Shell'
    And match otherNames9_iwNameType2 ==            'Local Language Name'
    And match otherNames9_countryOfRegistration2 == 'GB'
# ================================================================================
# ================================================================================
