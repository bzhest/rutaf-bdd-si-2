@api @public_api @postPublicSelfServiceThirdPartyBulkUploadADDThirdParty50Success
...
#      """
  ...
  Scenario: 39) C37786690 Third-party - ADD
    ...
    * def nameVarTARGET =       'ADD-3P-50-SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs    +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|Z1234          |Canada       |+18001      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme Inc. |Local Language Name|France            |Field1            |FULLUPDATE TEXT    \n"
    ...
    * def csvRows11 = "ADD        |                        |                |AAA11   |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |0018001     |www.test1.com|234|tst@email.com|Test desc. |                    |Acme Corp.|Local Language Name|France            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows12 = "ADD        |                        |                |AAA12   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |China        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows13 = "ADD        |                        |                |AAA13   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Afghanistan  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows14 = "ADD        |                        |                |AAA14   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Philippines  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows15 = "ADD        |                        |                |AAA15   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |United States|            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows16 = "ADD        |                        |                |AAA16   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |France       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows17 = "ADD        |                        |                |AAA17   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Italy        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows18 = "ADD        |                        |                |AAA18   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Brazil       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows19 = "ADD        |                        |                |AAA19   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Argentina    |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows20 = "ADD        |                        |                |AAA20   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Mexico       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"

    * def csvRows21 = "ADD        |                        |                |AAA21   |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |0018001     |www.test1.com|234|tst@email.com|Test desc. |                    |Acme Corp.|Local Language Name|France            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows22 = "ADD        |                        |                |AAA22   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |China        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows23 = "ADD        |                        |                |AAA23   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Afghanistan  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows24 = "ADD        |                        |                |AAA24   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Philippines  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows25 = "ADD        |                        |                |AAA25   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |United States|            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows26 = "ADD        |                        |                |AAA26   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |France       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows27 = "ADD        |                        |                |AAA27   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Italy        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows28 = "ADD        |                        |                |AAA28   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Brazil       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows29 = "ADD        |                        |                |AAA29   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Argentina    |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows30 = "ADD        |                        |                |AAA30   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Mexico       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"

    * def csvRows31 = "ADD        |                        |                |AAA31   |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |0018001     |www.test1.com|234|tst@email.com|Test desc. |                    |Acme Corp.|Local Language Name|France            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows32 = "ADD        |                        |                |AAA32   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |China        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows33 = "ADD        |                        |                |AAA33   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Afghanistan  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows34 = "ADD        |                        |                |AAA34   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Philippines  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows35 = "ADD        |                        |                |AAA35   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |United States|            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows36 = "ADD        |                        |                |AAA36   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |France       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows37 = "ADD        |                        |                |AAA37   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Italy        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows38 = "ADD        |                        |                |AAA38   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Brazil       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows39 = "ADD        |                        |                |AAA39   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Argentina    |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows40 = "ADD        |                        |                |AAA40   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Mexico       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"

    * def csvRows41 = "ADD        |                        |                |AAA41   |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|ZIP90210       |Canada       |0018001     |www.test1.com|234|tst@email.com|Test desc. |                    |Acme Corp.|Local Language Name|France            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
    * def csvRows42 = "ADD        |                        |                |AAA42   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |China        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows43 = "ADD        |                        |                |AAA43   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Afghanistan  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows44 = "ADD        |                        |                |AAA44   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Philippines  |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows45 = "ADD        |                        |                |AAA45   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |United States|            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows46 = "ADD        |                        |                |AAA46   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |France       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows47 = "ADD        |                        |                |AAA47   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Italy        |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows48 = "ADD        |                        |                |AAA48   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Brazil       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows49 = "ADD        |                        |                |AAA49   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Argentina    |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
    * def csvRows50 = "ADD        |                        |                |AAA50   |"+nameVarTARGET+"-"+nowMs+"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |                    |              |         |                 |           |         |           |             |            |              |      |        |               |Mexico       |            |             |   |             |           |                    |          |                   |                  |                  |                   |              |                         |           |                |\n"
...
#
    ...
    * def validateSuccess1 = ( retrieveSelfServiceProcess1_response.data.recordProcessed==50 && retrieveSelfServiceProcess1_response.data.recordWithErrors==0 )
