@api @public_api @postPublicSelfServiceThirdPartyBulkUploadFULLUPDATEUpdateOtherNamesSuccess
...
# Success: Other Name
    * def csvRows01 = "FULLUPDATE |"+ thirdPartyId       +"|                |1       |FULLUPDATE - "+ nowMs +"|            |        |                 |             |                 |                     |       |                |           |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |              |               |                |             |                       |              |              |         |                 |           |         |           |            |            |              |    |      |               |Canada     |            |       |   |             |           |MyOther OldName01   |MyOther Name01|Local Language Name|Brazil            |                  |                   |              |                         |           |                |\n"
