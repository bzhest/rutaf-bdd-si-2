@api @getRetrieveRenewalMatrix @siconnect_api
Feature: Get Retrieve Renewal Matrix

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Renewal Matrix
    Given url getUrl = baseTestUrl +'/dashboard/renewalMatrix'
