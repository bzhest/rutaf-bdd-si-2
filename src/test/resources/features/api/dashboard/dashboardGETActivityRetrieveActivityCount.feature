@api @getRetrieveActivityCount @siconnect_api
Feature: Get Retrieve Activity Count

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Activity Count
    Given url getUrl = baseTestUrl +'/dashboard/activityCount'
