@api @getRetrieveSuppliersForRenewal @siconnect_api
Feature: Get Retrieve Suppliers For Renewal

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Suppliers For Renewal
    Given url getUrl = baseTestUrl +'/suppliers-for-renewal'
