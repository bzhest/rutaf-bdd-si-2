@api @getRetrieveRenewalCycleTime @siconnect_api
Feature: Get Retrieve Renewal Cycle Time

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Renewal Cycle Time
    Given url getUrl = baseTestUrl +'/dashboard/renewalCycleTime'
