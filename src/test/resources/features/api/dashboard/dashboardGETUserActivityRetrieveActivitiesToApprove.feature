@api @getRetrieveActivitiesToApprove @siconnect_api
Feature: Get Retrieve Activities To Approve

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Activities To Approve
    Given url getUrl = baseTestUrl +'/activities-to-approve'
