@api @getRetrieveOnboardingMatrix @siconnect_api
Feature: Get Retrieve Onboarding Matrix

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Onboarding Matrix
    Given url getUrl = baseTestUrl +'/dashboard/onboardingMatrix'
