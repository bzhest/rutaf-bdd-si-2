@api @getRetrieveActivitiesToReview @siconnect_api
Feature: Get Retrieve Activities To Review

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Activities To Review
    Given url getUrl = baseTestUrl +'/activities-to-review'
