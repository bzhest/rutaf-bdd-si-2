@api @getRetrievePartnerVolume @siconnect_api
Feature: Get Retrieve Partner Volume

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Partner Volume
    Given url getUrl = baseTestUrl +'/dashboard/partnerVolume'
