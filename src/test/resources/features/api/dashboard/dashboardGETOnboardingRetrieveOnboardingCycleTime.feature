@api @getRetrieveOnboardingCycleTime @siconnect_api
Feature: Get Retrieve Onboarding Cycle Time

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Onboarding Cycle Time
    Given url getUrl = baseTestUrl +'/dashboard/onboardingCycleTime'
