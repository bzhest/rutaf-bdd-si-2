@api @getRetrieveOrderForApproval @siconnect_api
Feature: Get Retrieve Order For Approval

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Order For Approval
    Given url getUrl = baseTestUrl +'/order-for-approval'
