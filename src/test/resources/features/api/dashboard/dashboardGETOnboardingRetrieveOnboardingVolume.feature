@api @getRetrieveOnboardingVolume @siconnect_api
Feature: Get Retrieve Onboarding Volume

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Onboarding Volume
    Given url getUrl = baseTestUrl +'/dashboard/onboardingVolume'
