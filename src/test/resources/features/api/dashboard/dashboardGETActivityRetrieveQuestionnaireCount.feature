@api @getRetrieveQuestionnaireCount @siconnect_api
Feature: Get Retrieve Questionnaire Count

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Questionnaire Count
    Given url getUrl = baseTestUrl +'/dashboard/questionnaireCount'
