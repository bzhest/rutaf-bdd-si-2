@api @getRetrieveScreeningResultsToReview @siconnect_api
Feature: Get Retrieve Screening Results To Review

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Screening Results To Review
    Given url getUrl = baseTestUrl +'/screening-results-to-review'
