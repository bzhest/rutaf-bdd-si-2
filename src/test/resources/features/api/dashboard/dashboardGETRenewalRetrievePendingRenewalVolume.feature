@api @getRetrievePendingRenewalVolume @siconnect_api
Feature: Get Retrieve Pending Renewal Volume

  Background:
    * def baseTestUrl = 'https://dashboardspa.qa-sprint2.supplierintegrity.com'

  Scenario: Get Retrieve Pending Renewal Volume
    Given url getUrl = baseTestUrl +'/dashboard/pendingRenewalVolume'
