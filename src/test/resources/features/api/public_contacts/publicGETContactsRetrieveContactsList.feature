@api @public_api @getPublicContactsRetrieveSupplierContacts
Feature: Get Supplier Contacts List
...
#      """
  ...
  Scenario: 1) C36389412 RMS-5614 SIConnect Public API V2
               - Retrieve Third-party Contact List by start date date and end date
...
#      """
  ...
  Scenario: 2) C36389432 RMS-5614 SIConnect Public API V2
               - Retrieve Supplier Contact List by fields parameter
...
#
    ...
    And param start =          nowStartISODate4
    And param end =            nowEndISODate4
    And param fields =         'data.parent, data.id, data.name, data.firstName, data.lastName, data.status'
    And header X-Tenant-Code = xTenantCode
    And header Authorization = 'Bearer '+ accessToken
    When method GET
    Then status 200
...
#
  ...
  Scenario: 3) C36391867 RMS-5614 SIConnect Public API V2
               - Retrieve Supplier Contact List - Incorrect date range
