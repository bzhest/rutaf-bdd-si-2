@api @public_api @getPublicThirdPartyContactsRetrieveNoContactsOffsetList
...
#      """
  ...
  Scenario: 3) C41064167 Public API - GET /thirdparty/{id}/contacts/offset-list
               - Retrieve Third-party ID without contact
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-CONTNONE-OFSTLIST-SUCC'
