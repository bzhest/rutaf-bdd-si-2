@api @public_api @getPublicThirdPartyContactsRetrieveAllContactsOffsetListInvThirdPartyId
...
#      """
  ...
  Scenario: 4) C41064172 Public API - GET /thirdparty/{id}/contacts/offset-list
               - Invalid Third-party ID
...
### #####################################################################################################################
    ...
    * def thirdPartyId =    'XxXxXxXxXxXxXxXx'
#    * def name =           'Neo'
#    * def fetchType =      'ALL'
#    * def page =           0
#    * def pageSize =       5
