@api @public_api @getPublicThirdPartyContactsRetrieveRecentContactsOffsetList
...
#      """
  ...
  Scenario: 2) C41064160 Public API - GET /thirdparty/{id}/contacts/offset-list
               - Retrieve Recently Added Contacts for specific Third-party
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-CONTREC-OFSTLIST-SUCC'
...
#    * def xTenantCode =    xTenantCode
    ...
    * def retrieveContactsOffsetListResult = call read( "./call/getContactsOffsetList.feature" )   { "thirdPartyId": "#(thirdPartyId)", "name": "#(name)", "fetchType": "#(fetchType)", "page": "#(page)", "pageSize": "#(pageSize)", "fields": "#(fields)", "requestorEmail": "#(requestorEmail)", "xTenantCode": "#(xTenantCode)" }
