@api @public_api @getPublicThirdPartyRetrieveAllThirdPartyOffsetList
...
#      """
  ...
  Scenario: 1) C41064144 Public API - GET /thirdparty/offset-list
               - Retrieve Third-party List - All Third-party
    ...
    * def nameVarTARGET =       'ADD-3P-GOLD-ALLOFSTLST-SUCC'
