@api @public_api @getPublicThirdPartyRetrieveAllThirdPartyOffsetListSortByRiskTier
...
#      """
  ...
  Scenario: 1) C41064150 Public API - GET /thirdparty/offset-list
               - Sort by +RiskTier
    ...
    * def nameVarTARGET =       'ADD-3P-GOLD-SORTRISKOFSTLST-SUCC'
...
#   * def csvRows01 = "FULLUPDATE |"+    thirdPartyId    +"|"+    nowMs   +"|1       |FULLUPDATE - "+ nowMs    +"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987            |10M    |11/02/2008      |SOE        |si_admin@yopmail.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Americas|Z1234          |Canada     |+18001      |www.test1.com|123|test1@test.ph|Desc abc123|                    |Acme Inc. |Local Language Name|France            |Field1            |FULLUPDATE TEXT    \n"
    * def csvRows01 = "ADD        |                        |"+    nowMs   +"|1       |"+nameVarTARGET+"-"+nowMs+"|CORP        |USD     |5K-10K           |AHI          |PRS              |02/22/1987           |10M    |11/02/2008      |SOE        |rddcentre.admin.np@refinitiv.com|MyDivision|Default       |OTS           |DIST_M_SRC     |OTS             |MULTI        |LITTLE_VIS             |COMMODITIZED_PRODUCT|A3P           |MoneyBank|12 Finance Avenue|12345678   |Reno     |MB Reno Br.|United States|12 Main Ave.|Ontario       |Ottawa|Asia    |ZIP90210       |China     |0018001     |www.test1.com|234|tst@email.com|Test desc. |                    |Acme Corp.|Local Language Name|France            |Field1            |Test CUSTOM FLD VAL|              |                         |           |                |\n"
...
#    * assert dataLength <= pageSize
    ...
    * def riskLevels = $retrieveThirdPartyOffsetListResult.response.data[*].riskTier
    * print "################################ riskLevels = \n", riskLevels
    ...
    * copy riskLevelsAsc = riskLevels
    * def riskLevelsAscResult = stringSort( riskLevelsAsc, 'ASC' )
    * print "################################ riskLevelsAscResult = \n", riskLevelsAscResult

    * match riskLevels == riskLevelsAscResult
...
#    * def deleteThirdPartyResult1 = call read( "./call/deleteThirdParty.feature" ) thirdPartyIdsTODAYTARGETArr
  ...
  Scenario: 2) C41064150 Public API - GET /thirdparty/offset-list
               - Sort by -RiskTier
...
#    * assert dataLength <= pageSize
    ...
    * copy riskLevelsDesc = riskLevels
    * def riskLevelsDescResult = stringSort( riskLevelsDesc, 'DESC' )
    * print "################################ riskLevelsDescResult = \n", riskLevelsDescResult

    * match riskLevels == riskLevelsDescResult
