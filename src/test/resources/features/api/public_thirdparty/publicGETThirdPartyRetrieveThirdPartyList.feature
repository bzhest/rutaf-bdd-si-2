@api @public_api @getPublicThirdPartyRetrieveThirdPartyList
Feature: Get Third Party List
...
#      """
  ...
  Scenario: 1) C36277675 RMS-5598 - SIConnect Public API V2
               - Retrieve Third Party List by start date date and end date
...
#
    ...
    * def count = response.data.length
    And print '\n'
    And print '================================'
    And print '******** RETRIEVE THIRD-PARTY LIST: RETRIEVE THIRD-PARTY LIST'
...
#
  ...
  Scenario: 2) C36277771 RMS-5598 - SIConnect Public API V2
               - Retrieve Third Party List by fields parameter
#
# CREATE third-party
#
    * def requestBody_createThirdParty =
    ...
    * def incDateResp =       response.data.incorporationDate
    ...
    And print '\n'
    And print '================================'
    And print '******** RETRIEVE THIRD-PARTY'
    And print '******** TEST   : nowMs             = '+ nowMs
    And print '********        : nowISODate        = '+ nowISODate
    And print '********        : nowEpochTimeMs    = '+ nowEpochTimeMs
    And print '********        :'
...
#
# RETRIEVE third-party list for TODAY with specified 'fields' - expected: FOUND
#
    Given url getUrl = baseTestUrl
    And path 'thirdparty'
    And param pageSize =       400
    And param start =          nowStartISODate4
    And param end =            nowEndISODate4
    And param fields =         'data.id, data.referenceNo, data.name, data.status, data.country'
    And header X-Tenant-Code = xTenantCode
    And header Authorization = 'Bearer '+ accessToken
    When method GET
    Then status 200
...
#    And print '\n'
#    And print '================================'
#    And print '******** RETRIEVE THIRD-PARTY LIST'
#    And print '******** COUNT: data.length = '+ count
...
#      """
  ...
  Scenario: 3) C36277729 RMS-5598 - SIConnect Public API V2
               - Retrieve Third Party List by Reference No
...
#
# RETRIEVE third-party list for TODAY with specified 'fields' = 'referenceNo' - expected: FOUND
#
    Given url getUrl = baseTestUrl
    And path 'thirdparty'
    And param pageSize =       400
    And param start =          nowStartISODate4
    And param end =            nowEndISODate4
    And param fields =         'data.referenceNo'
    And header X-Tenant-Code = xTenantCode
    And header Authorization = 'Bearer '+ accessToken
    When method GET
    Then status 200
    ...
    * def count = response.data.length
    ...
    And print '\n'
    And print '================================'
    And print '******** RETRIEVE THIRD-PARTY LIST: RETRIEVE THIRD-PARTY LIST - FIELD REFERENCE NO. ONLY'
    And print '******** COUNT: data.length = '+ count
    And print '================================\n'
    And print '\n'
...
#
  ...
  Scenario: 4) C36277921 RMS-5598 - SIConnect Public API V2
               - Retrieve Third Party List - Date range is invalid (Response code:400)
...
#
# Test when 'start' & 'end' datetime are of invalid format
#
    Given url getUrl = baseTestUrl
    And path 'thirdparty'
    And param pageSize =       400
          ...
          errors: [
            {
              field:       'start',
              code:        'SI-ERR-003',
              description: 'start is not valid.'
            }
          ]
        }
      """
