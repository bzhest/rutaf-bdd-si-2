@api @public_api @getPublicThirdPartyContactsRetrieveAllContactsOffsetListSpecFields
...
#      """
  ...
  Scenario: 6) C41064173 Public API - GET /thirdparty/{id}/contacts/offset-list
               - Display by specific fields
...
#    And print "******** CONTACTSHEADERS  = '"+ contactsTemplateHeaders +"'"
    ...
    * def nameVarTARGET =       'ADD-3P-CONTALL-SPECFLDS-OFSTLIST-SUCC'
...
#    * assert dataLength <= pageSize
    ...
    And match retrieveContactsOffsetListResult.response ==
      """
         {
           data:    '##[] ^^ {
                                 id:                "#string",
