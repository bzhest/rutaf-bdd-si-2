@api @public_api @getPublicThirdPartyRelatedFilesRetrieveThirdPartyRelatedFiles
...
#      """
  ...
  Scenario: 1) C41043251 Public API - GET /thirdparty/{id}/related-files
               - Retrieve Third-party with Related Files
    ...
    * def nameVarTARGET =       'ADD-3P-RELFLS-SUCC'
...
#    * def xTenantCode =    xTenantCode
    ...
    * def retrieveThirdPartyRelatedFilesResult = call read( "./call/getThirdPartyRelatedFiles.feature" )   { "thirdPartyId": "#(thirdPartyId)", "requestorEmail": "#(requestorEmail)", "xTenantCode": "#(xTenantCode)" }

#    * print "################################ retrieveThirdPartyRelatedFilesResult = \n", retrieveThirdPartyRelatedFilesResult
    * def relatedFilesLength = retrieveThirdPartyRelatedFilesResult.response.data.relatedFiles.length

    * match relatedFilesLength == fileCount
