@api @public_api @getPublicThirdPartyRetrieveAllThirdPartyOffsetListSortByCountry
...
#      """
  ...
  Scenario: 1) C41064148 Public API - GET /thirdparty/offset-list
               - Sort by +Country
    ...
    * def nameVarTARGET =       'ADD-3P-GOLD-SORTCTRYOFSTLST-SUCC'
...
#    * assert dataLength <= pageSize
    ...
    * def countrys = $retrieveThirdPartyOffsetListResult.response.data[*].country
    * print "################################ countrys = \n", countrys
    ...
    * copy countrysAsc = countrys
    * def countrysAscResult = stringSort( countrysAsc, 'ASC' )
    * print "################################ countrysAscResult = \n", countrysAscResult

    * match countrys == countrysAscResult
...
#    * print "################################ namesAsc = \n", namesAsc
#    * match names == namesAsc

#    * copy namesDesc = names
#    * Collections.sort( namesDesc, Collections.reverseOrder() )
#    * print "################################ namesDesc = \n", namesDesc
#    * match names == namesDesc
...
#    * def deleteThirdPartyResult1 = call read( "./call/deleteThirdParty.feature" ) thirdPartyIdsTODAYTARGETArr
  ...
  Scenario: 2) C41064148 Public API - GET /thirdparty/offset-list
               - Sort by -Country
...
#    * assert dataLength <= pageSize
    ...
    * copy countrysDesc = countrys
    * def countrysDescResult = stringSort( countrysDesc, 'DESC' )
    * print "################################ countrysDescResult = \n", countrysDescResult

    * match countrys == countrysDescResult
