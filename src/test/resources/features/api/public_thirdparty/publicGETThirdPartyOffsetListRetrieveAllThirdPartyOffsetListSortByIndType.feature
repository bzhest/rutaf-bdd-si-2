@api @public_api @getPublicThirdPartyRetrieveAllThirdPartyOffsetListSortByIndType
...
#      """
  ...
  Scenario: 1) C41064147 Public API - GET /thirdparty/offset-list
               - Sort by +IndustryType
    ...
    * def nameVarTARGET =       'ADD-3P-GOLD-SORTINDOFSTLST-SUCC'
...
################################################################################
# Retrieve THIRD-PARTY OFFSET-LIST
################################################################################
...
#    * assert dataLength <= pageSize
    ...
    * def industryTypesAscResult = stringSort( industryTypesAsc, 'ASC' )
    * print "################################ industryTypesAscResult = \n", industryTypesAscResult

    * match industryTypes == industryTypesAscResult
...
#    * def deleteThirdPartyResult1 = call read( "./call/deleteThirdParty.feature" ) thirdPartyIdsTODAYTARGETArr
  ...
  Scenario: 2) C41064147 Public API - GET /thirdparty/offset-list
               - Sort by -IndustryType
...
#    * assert dataLength <= pageSize
    ...
    * copy industryTypesDesc = industryTypes
    * def industryTypesDescResult = stringSort( industryTypesDesc, 'DESC' )
    * print "################################ industryTypesDescResult = \n", industryTypesDescResult

    * match industryTypes == industryTypesDescResult
