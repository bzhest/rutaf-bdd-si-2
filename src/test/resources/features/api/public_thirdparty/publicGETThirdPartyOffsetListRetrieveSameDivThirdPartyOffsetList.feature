@api @public_api @getPublicThirdPartyRetrieveSameDivThirdPartyOffsetList
...
#      """
  ...
  Scenario: 1) C41064145 Public API - GET /thirdparty/offset-list
               - Retrieve Third-party List - My Third-party (all third-parties under the same division as the user)
    ...
    * def nameVarTARGET =       'ADD-3P-GOLD-SAMEDIVOFSTLST-SUCC'
