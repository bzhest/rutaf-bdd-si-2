@api @public_api @getPublicThirdPartyRetrieveAllThirdPartyOffsetListSortByName
...
#      """
  ...
  Scenario: 1) C41064146 Public API - GET /thirdparty/offset-list
               - Sort by +Name
    ...
    * def nameVarTARGET =       'ADD-3P-GOLD-SORTNAMEOFSTLST-SUCC'
...
#    * assert dataLength <= pageSize
    ...
    * def names = $retrieveThirdPartyOffsetListResult.response.data[*].name
    * print "################################ names = \n", names
    ...
    * copy namesAsc = names
    * def namesAscResult = stringSort( namesAsc, 'ASC' )
    * print "################################ namesAscResult = \n", namesAscResult

    * match names == namesAscResult
...
#    * def deleteThirdPartyResult1 = call read( "./call/deleteThirdParty.feature" ) thirdPartyIdsTODAYTARGETArr
  ...
  Scenario: 2) C41064146 Public API - GET /thirdparty/offset-list
               - Sort by -Name
...
#    * assert dataLength <= pageSize
    ...
    * copy namesDesc = names
    * def namesDescResult = stringSort( namesDesc, 'DESC' )
    * print "################################ namesDescResult = \n", namesDescResult

    * match names == namesDescResult
