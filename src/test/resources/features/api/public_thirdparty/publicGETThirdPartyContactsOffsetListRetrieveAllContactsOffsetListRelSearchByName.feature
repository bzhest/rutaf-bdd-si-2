@api @public_api @getPublicThirdPartyContactsRetrieveAllContactsOffsetListRelSearchByName
...
#      """
  ...
  Scenario: 5) C41064169 Public API - GET /thirdparty/{id}/contacts/offset-list
               - Relevant Search for Contact
