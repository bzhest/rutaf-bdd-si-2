...
So that I can hide the configuration to User Group and Pending for Assignment
  ...
  @C53680527 @core_regression
  Scenario: C53680527: Workflow Activity - DDO - Automation Logic - Auto-ordering configuration is ON - Disable User Group/Pending For Assignment for Organisation: Save Activity Change
  ...
  @C54353616 @core_regression
  Scenario: C54353616: Workflow Activity - DDO - Automation Logic - Auto-ordering configuration is ON - Disable User Group/Pending For Assignment for Individual: Save Activity Changes
    When User selects Activity Type as "Order Due Diligence Report"
    And User ticks Automatically order recommended scope of Due Diligence report checkbox
