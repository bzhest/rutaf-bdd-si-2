...
Feature: Associated Individual Other Names - Media Check - Media Resolution / Filtering
  ...
  @C42712134
  Scenario: C42712134: Associated Individual Other Names - Verify the user should be redirected to the recently view article on the main screening page when user selected Risk Level = High and MEDIUM and LOW
  ...
  @C42712134
  Scenario: C42712134: Associated Individual Other Names - Verify the user should be redirected to the recently view article on the main screening page when user selected Risk Level = NO_RISK and UNKNOWN
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C42713035
  Scenario: C42713035: Associated Individual Other Names - Verify the user should see X Items Selected articles when user navigate back from screening detail page when user selects Risk Level = HIGH
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
...
#    And Media check screening record on position 3 is checked
  ...
  @C42713035
  Scenario: C42713035: Associated Individual Other Names - Verify the user should see X Items Selected articles when user navigate back from screening detail page when user selects Risk Level = NO_RISK and UNKNOWN
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
...
#    And Media check screening record on position 3 is checked
  ...
  @C40160727
  Scenario: C40160727: Associated Individual Other Names - Media Resolution - Pending Review - Verify media resolution section is correct
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160728
  Scenario: C40160728: Associated Individual Other Names - Media Resolution - Pending Review - Verify Select All check box and Clear All link are working correctly
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160729
  Scenario: C40160729: Associated Individual Other Names - Media Resolution - Pending Review - Verify records can be selected across the page
    When User creates Other name "Barac Obama" for Associated Party
    Then Screening results table is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160731
  Scenario: C40160731: Associated Individual Other Names - Media Resolution - Pending Review - Verify Clear All link label clear all the records that are across the page
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
    ...
    Then Clear All button is disappeared
    And Media Check Other Names Result 10 Records is not checked
    And Media Check does not displays 13 items selected
    When User clicks previous page
    Then Media Check Other Names Result 10 Records is not checked

  @C40160732
  Scenario: C40160732: Associated Individual Other Names - Media Resolution - Pending Review - Verify "X items selected" link label filters only the selected articles
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160733
  Scenario: C40160733: Associated Individual Other Names - Media Resolution - Pending Review - Verify Attach pop up modal
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160734
  Scenario: C40160734: Associated Individual Other Names - Media Resolution - Pending Review - Verify user can assign Risk Level and Comment when user turns on "X items selected" filter
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
    ...
    Then Media Check displays 3 items selected
    When User clicks next page
    And User selects Media Check Associated Party Individual Other Names screening record on position 1
    And User selects Media Check Associated Party Individual Other Names screening record on position 2
    And User selects Media Check Associated Party Individual Other Names screening record on position 3
    Then Media Check displays 6 items selected
    ...
    When User clicks "SAVE" Media Check Attach modal button
    Then Other Name dialog is loaded
    And Contacts media check Other Names screening record on position 1 displays High icon
    ...
    And Contacts media check Other Names screening record on position 2 displays High icon
  ...
  @C40160735
  Scenario: C40160735: Associated Individual Other Names - Media Resolution - Pending Review - Single Record - Same Page - user can mark article with High risk (with comment)
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160736
  Scenario: C40160736: Associated Individual Other Names - Media Resolution - Pending Review - Batch Record- Same Page - Verify user can mark article with Medium risk (without comment)
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
    ...
    And Contacts media check Other Names screening record on position 2 displays Medium icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 2
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed
    And Contacts media check Other Names screening record on position 3 displays Medium icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 3
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed

  @C40160737
  Scenario: C40160737: Associated Individual Other Names - Media Resolution - Pending Review - Batch Record - Different Page - Verify user can mark article with Low risk (with comment)
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
    ...
    When User clicks "SAVE" Media Check Attach modal button
    Then Other Name dialog is loaded
    And Contacts media check Other Names screening record on position 1 displays Low icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 1
    ...
    And Contacts media check Other Names screening record on position 2 displays Low icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 2
    Then Media Check Other Name Risk Level ToolTip "Test assigning resolution with comment for batch different page record" is displayed
    And Contacts media check Other Names screening record on position 3 displays Low icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 3
    Then Media Check Other Name Risk Level ToolTip "Test assigning resolution with comment for batch different page record" is displayed
    When User clicks previous page
    Then Screening results table is loaded
  ...
  @C40160738
  Scenario: C40160738: Associated Individual other names - Media Resolution - Pending Review - Select All Record - Same Page - user can mark article with No Risk (with comment)
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
    ...
    When User clicks "SAVE" Media Check Attach modal button
    Then Other Name dialog is loaded
    And Contacts media check Other Names screening record on position 1 displays No Risk icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 1
    ...
    And Contacts media check Other Names screening record on position 3 displays No Risk icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 3
    Then Media Check Other Name Risk Level ToolTip "Test assigning resolution with comment for Select all same page record" is displayed
    And Contacts media check Other Names screening record on position 5 displays No Risk icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 5
    Then Media Check Other Name Risk Level ToolTip "Test assigning resolution with comment for Select all same page record" is displayed

  @C40160739
  Scenario: C40160739: Associated Individual other names - Media Resolution - Pending Review - Select All Record - Different Page - user can mark article with Unknown (without comment)
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
    ...
    When User clicks "SAVE" Media Check Attach modal button
    Then Screening results table is loaded
    And Contacts media check Other Names screening record on position 2 displays Unknown icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 2
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed
    And Contacts media check Other Names screening record on position 4 displays Unknown icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 4
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed
    And Contacts media check Other Names screening record on position 5 displays Unknown icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 5
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed
    When User clicks previous page
    ...
    When User hovers Media Check Other Names Risk Level icon on Screening record 1
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed
    And Contacts media check Other Names screening record on position 3 displays Unknown icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 3
    Then Media Check Other Name Risk Level ToolTip "No Risk reason indicated" is displayed
    And Contacts media check Other Names screening record on position 4 displays Unknown icon
    When User hovers Media Check Other Names Risk Level icon on Screening record 4
  ...
  @C40160823
  Scenario: C40160823: Associated Individual other names - Media Check Tab - Screening - Attached Risk Level - Verify  Add toast message and forbid when the user tries to attach article with old risk level
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40160833
  Scenario: C40160833: Associated Individual other names - Media Check Tab - Screening - Attached Risk Level - Verify  risk level is attach to article which has no risk level  when the user tries to attach  1  article with old risk level  and 1 article with no risk level
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40173624
  Scenario: C40173624: Associated Individual Other Names - Media Check Tab - Media Resolution box - Attached Risk Level - Verify  Display toast message when the user select more than 200 articles [200 articles have not been attached with a risk level]
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40173625
  Scenario: C40173625: Associated Individual Other Names - Media Check Tab - Media Resolution box - Attached Risk Level - Verify  Display toast message when the user is trying to select more than 200 articles [200 articles have been attached with a risk level]
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
  ...
  @C40173624
  Scenario: C40173624: Associated Individual Other Names - Media Check Tab - Media Resolution box - Attached Risk Level - Verify  Display toast message when the user is trying to select more than 200 articles[ some articles have been attached with a risk level and some not]
    When User creates Other name "Barac Obama" for Associated Party
    Then Other Name dialog is loaded
    When User clicks on "MEDIA CHECK" other name screening tab
    Then Other Name dialog is loaded
