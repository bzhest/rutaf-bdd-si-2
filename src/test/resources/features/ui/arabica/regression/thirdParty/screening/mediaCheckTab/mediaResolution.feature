...
Feature: Third-party - Media Check - Media Resolution / Filtering
  ...
  @C42712118
  Scenario: C42712118: third-Party - Verify the user should be redirected to the recently view article on the main screening page when user selected Risk Level = High and MEDIUM and LOW
  ...
  @C42712118
  Scenario: C42712118: third-Party - Verify the user should be redirected to the recently view article on the main screening page when user selected Risk Level = NO_RISK and UNKNOWN
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects "25" option from Rows Per Page dropdown list
  ...
  @C42712483
  Scenario: C42712483: third-Party - Verify the user should see X Items Selected articles when user navigate back from screening detail page when user selects Risk Level = HIGH
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
...
#    And Media check screening record on position 3 is checked
  ...
  @C42712483
  Scenario: C42712483: third-Party - Verify the user should see X Items Selected articles when user navigate back from screening detail page when user selects Risk Level = NO_RISK and UNKNOWN
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
...
#    And Media check screening record on position 3 is checked
  ...
  @C39482214
  Scenario: C39482214: third-Party - Media Resolution - Pending Review - Verify media resolution section is correct
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
  ...
  @C39482297
  Scenario: C39482297: third-Party - Media Resolution - Pending Review - Verify Select All check box and Clear All link are working correctly
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
  ...
  @C39483030
  Scenario: C39483030: third-Party - Media Resolution - Pending Review - Verify Select All check box and Clear All link are working correctly
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
  ...
  @C39483081
  Scenario: C39483081: third-Party - Media Resolution - Pending Review - Verify Clear All link label clear all the records that are across the page
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
    ...
    When User clicks previous page
    Then  Media Check Result 10 Records is not checked

  @C39483100
  Scenario: C39483100: third-Party - Media Resolution - Pending Review - Verify "X items selected" link label filters only the selected articles
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
  ...
  @C39516295
  Scenario: C39516295: third-Party - Media Resolution - Pending Review - Verify Attach pop up modal
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
  ...
  @C39503946
  Scenario: C39503946: third-Party - Media Resolution - Pending Review - Verify user can assign Risk Level and Comment when user turns on "X items selected" filter
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
    ...
    And Third-party Media Check screening record on position 3 displays High icon
  ...
  @C39483113
  Scenario: C39483113: third-Party - Media Resolution - Pending Review - Single Record - Same Page - user can mark article with High risk (with comment)
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
  ...
  @C39483157
  Scenario: C39483157: third-Party - Media Resolution - Pending Review - Batch Record- Same Page - Verify user can mark article with Medium risk (without comment)
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
    ...
    And Third-party Media Check screening record on position 2 displays Medium icon
    When User hovers Media Check Risk Level icon on Screening record 2
    Then Media Check Risk Level ToolTip "No Risk reason indicated" is displayed on record 2
    And Third-party Media Check screening record on position 3 displays Medium icon
    When User hovers Media Check Risk Level icon on Screening record 3
    Then Media Check Risk Level ToolTip "No Risk reason indicated" is displayed on record 3

  @C39483158
  Scenario: C39483158: third-Party - Media Resolution - Pending Review - Batch Record - Different Page - Verify user can mark article with Low risk (with comment)
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
    ...
    When User clicks "SAVE" Media Check Attach modal button
    Then Screening results table is loaded
    And Third-party Media Check screening record on position 1 displays Low icon
    When User hovers Media Check Risk Level icon on Screening record 1
    ...
    And Third-party Media Check screening record on position 2 displays Low icon
    When User hovers Media Check Risk Level icon on Screening record 2
    ...
    And Third-party Media Check screening record on position 3 displays Low icon
    When User hovers Media Check Risk Level icon on Screening record 3
  ...
  @C39483165
  Scenario: C39483165: third-Party - Media Resolution - Pending Review - Select All Record - Same Page - user can mark article with No Risk (with comment)
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
    ...
    When User clicks "SAVE" Media Check Attach modal button
    Then Screening results table is loaded
    And Third-party Media Check screening record on position 1 displays No Risk icon
    When User hovers Media Check Risk Level icon on Screening record 1
    ...
    And Third-party Media Check screening record on position 3 displays No Risk icon
    When User hovers Media Check Risk Level icon on Screening record 3
    ...
    And Third-party Media Check screening record on position 5 displays No Risk icon
  ...
  @C39483166
  Scenario: C39483166: third-Party - Media Resolution - Pending Review - Select All Record - Different Page - user can mark article with Unknown (without comment)
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User clicks on select all checkBox of media check page
    ...
    When User hovers Media Check Risk Level icon on Screening record 1
    Then Media Check Risk Level ToolTip "No Risk reason indicated" is displayed on record 1
    And Third-party Media Check screening record on position 3 displays Unknown icon
    When User hovers Media Check Risk Level icon on Screening record 3
    Then Media Check Risk Level ToolTip "No Risk reason indicated" is displayed on record 3
    And Third-party Media Check screening record on position 5 displays Unknown icon
    When User hovers Media Check Risk Level icon on Screening record 5
  ...
  @C40160820
  Scenario: C40160820: third-Party - Media Check Tab - Screening - Attached Risk Level - Verify  Add toast message and forbid when the user tries to attach article with old risk level
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
  ...
  @C40160826
  Scenario: C40160826: third-Party - Media Check Tab - Screening - Attached Risk Level - Verify  risk level is attach to article which has no risk level  when the user tries to attach  1  article with old risk level  and 1 article with no risk level
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects Third-party Media Check screening record on position 1
  ...
  @C39924888
  Scenario: C39924888: third-Party - Media Check Tab - Media Resolution box - Attached Risk Level - Verify  Display toast message when the user is trying to select more than 200 articles [200 articles have been attached with a risk level]
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
  ...
  @C40031364
  Scenario: C40031364: third-Party - Media Check Tab - Media Resolution box - Attached Risk Level - Verify  Display toast message when the user is trying to select more than 200 articles [200 articles have not been attached with a risk level]
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects "50" option from Rows Per Page dropdown list
  ...
  @C40031365
  Scenario: C40031365: third-Party - Media Check Tab - Media Resolution box - Attached Risk Level - Verify  Display toast message when the user is trying to select more than 200 articles[ some articles have been attached with a risk level and some not]
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
    And Screening results table is loaded
    When User selects "50" option from Rows Per Page dropdown list
