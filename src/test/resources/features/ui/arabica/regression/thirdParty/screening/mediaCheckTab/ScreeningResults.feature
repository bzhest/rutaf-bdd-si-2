...
Feature: Third-party - Media check screening results
  ...
  @C37483867
  Scenario: C37483867: third-Party - Verify User should be redirected to the recently view article in the main screening page after navigating back from article detail page
  ...
  @C42712450
  Scenario: C42712450: third-Party - Verify the user should see X Items Selected articles when user navigate back from screening detail page
    When User clicks on "MEDIA CHECK" tab
    Then "MEDIA CHECK" tab is displayed
