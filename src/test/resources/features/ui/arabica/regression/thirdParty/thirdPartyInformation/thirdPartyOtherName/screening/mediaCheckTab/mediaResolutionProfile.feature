...
Feature: Third-party Other Names - Media Check Profile/Screening Detail - Media Resolution / Filtering
  ...
  @C40106388
  Scenario: C40106388: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Verify  Display risk levels  as unselected all when there's no risk level was selected
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106389
  Scenario: C40106389: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Comment box - Verify  the comment will not disabled   if risk level is selected
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
  ...
  @C40106390
  Scenario: C40106390: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Comment box - Verify  the comment will not disabled   if risk level has been marked
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106392
  Scenario: C40106392: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Verify "Attach" button (default: disabled)
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106393
  Scenario: C40106393: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Verify "Attach" button is active when the user selects one of the risk level In case that No risk level has been attached
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106394
  Scenario: C40106394: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Verify "Attach" button is active when the user selects one of the risk level In case risk level has been attached
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106396
  Scenario: C40106396: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box - Verify Comment box can be empty when being attached to a risk level
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106403
  Scenario: C40106403: third-Party Other Names  - Media Check Tab -  Screening Detail - Media Resolution box - Comment box -Verify Comment limit 2000 characters following WC1
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106409
  Scenario: C40106409: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box -  Verify Tag as red flag (read-only toggle) and display tooltip
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40106410
  Scenario: C40106410: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box -  Verify The "Tag As Red Flag" option will be available in the confirmation screen after you selected the risk level and filled in the comment section.
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C40160819
  Scenario: C40160819: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box -   Verify  Risk level can replaced  when the user tries to attach article with old risk level
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
  ...
  @C47361198
  Scenario: C47361198: third-Party Other Names - Media Check Tab -  Screening Detail - Media Resolution box -  Verify  Display toast message when the user is trying to select more than 200 articles [200 articles have been attached with a risk level]
    When User creates Other name "Bank of China"
    And User opens screening results for "Bank of China" Other name
    Then Other Name dialog is loaded
    And Sorted search "World-Check" results for "Bank of China" "supplier" appear in other names screening table for current page
