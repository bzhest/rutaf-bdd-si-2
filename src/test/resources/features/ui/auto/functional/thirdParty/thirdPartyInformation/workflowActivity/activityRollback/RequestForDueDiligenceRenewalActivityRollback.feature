...
Feature: Activity Rollback - Request for Due Diligence Renewal Activity Rollback
  ...
  Background:
    ...
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_1_1" with "Request for Due Diligence Activity" data
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_1_2" with "Simple Custom Activity" data
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_1_3" with "Assessment One Field Custom Activity" data
    And User clicks Add Wizard Component button
    And User updates Component Name "Group_2"
    And User clicks Check button
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_2_1" with "Simple Custom Activity" data
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_2_2" with "Simple Custom Activity" data
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_2_3" with "Simple Custom Activity" data
    And User adds new Activity "AUTO_TEST_REQUEST_D_D_RENEWAL_2_4" with "Simple Custom Activity" data
    ...
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_1_1" branching modal activity
    And User selects "AUTO_TEST_REQUEST_D_D_RENEWAL_2_1" for "first" drop-down
    And User selects "AUTO_TEST_REQUEST_D_D_RENEWAL_2_2" for "second" drop-down
    And User clicks workflow button "Apply"
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_1_3" branching modal activity
    And User selects "AUTO_TEST_REQUEST_D_D_RENEWAL_2_3" for "first" drop-down
    And User clicks workflow button "Apply"
    And User clicks workflow button "Done"
    ...
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_1_1" activity
    And User clicks Edit button for Activity
    And User selects activity status "Done"
    And User selects activity Assessment "first"
    And User clicks 'Save' activity button
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_1_2" activity
    And User clicks Edit button for Activity
    And User selects activity status "Done"
    And User clicks 'Save' activity button
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_1_3" activity
    And User clicks Edit button for Activity
    And User selects activity status "Done"
    And User selects activity Assessment "first"
    And User clicks 'Save' activity button
    And User clicks "Group_2" component tab
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_2_1" activity
    And User clicks Edit button for Activity
    And User selects activity status "Done"
    And User clicks 'Save' activity button
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_2_3" activity
    And User clicks Edit button for Activity
    And User selects activity status "Done"
    And User clicks 'Save' activity button
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_2_4" activity
    And User clicks Edit button for Activity
    And User selects activity status "Done"
    And User clicks 'Save' activity button
    ...
    Then Alert Dialog with text is displayed
      ...
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_1                            |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_4                            |
    ...
    Then Activities table should contain the following activity
      ...
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_1 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_2 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN |          | Not Started |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_3 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_4 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |

  @C36822762
  @onlySingleThread
  @email
  Scenario: C36822762: [1] Supplier Onboarding - Request For Due Diligence Rollback - Change Completed->In progress if succeeding activities not started, no reviewer - Renewal - Leave assessment activity
    Then Email notification "Activity Assigned" with following values is received by "Assignee" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_1_1 |
    And Email notification "Activity Recalled" with following values is received by "Admin" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_2_1 |
    And Email notification "Activity Recalled" with following values is received by "Admin" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_2_4 |
    ...
    And Email notification "Activity Assigned" with following values is not received by "Admin" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_2_3 |
  ...
  @onlySingleThread
  @email
  Scenario: C36822762: [1] Supplier Onboarding - Request For Due Diligence Rollback - Change Completed->In progress if succeeding activities not started, no reviewer - Renewal - Edit assessment activity
    When User deletes last emails for user "Admin"
    And User clicks "Group_1" component tab
    And User clicks on "AUTO_TEST_REQUEST_D_D_RENEWAL_1_1" activity
    And User clicks Edit button for Activity
    ...
    Then Activities table should contain the following activity
      | Name                              | Type                           | Assigned To             | Due Date | Status      |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_2 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_3 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_4 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |
    And Activities table doesn't contain the following activity
      | Name                              | Type                           | Assigned To             | Due Date | Status      |
      | AUTO_TEST_REQUEST_D_D_RENEWAL_2_1 | AUTO_TEST_SIMPLE_ACTIVITY_TYPE | Admin_AT_FN Admin_AT_LN | TODAY+1  | Not Started |
    And Email notification "Activity Assigned" with following values is received by "Admin" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_2_2 |
    And Email notification "Activity Assigned" with following values is received by "Admin" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_2_4 |
    And Email notification "Activity Assigned" with following values is not received by "Admin" user
      | <Activity_Name> | AUTO_TEST_REQUEST_D_D_RENEWAL_2_3 |
